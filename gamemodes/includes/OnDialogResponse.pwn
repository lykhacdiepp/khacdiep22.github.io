...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	if(dialogid == TRUNGTHU)
	{
		if(response)
		{
			if(listitem == 0)
			{
			ShowPlayerDialog(playerid, TRUNGTHU1, DIALOG_STYLE_LIST, "Chao ban hay chon mon qua ma ban muon", "Vip Bac 7 ngay\nVip Gold 30 Ngay\nPhieu xe mien phi", "O", "X");
			}
			if(listitem == 1)
			{
			}
...
//				PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
	...
	if(dialogid == TRUNGTHU1)
	{
		if(response)
		{
		if(listitem == 0)
		{
		if(PlayerInfo[playerid][pBanhTrungThu] > 10) {
		if(PlayerInfo[playerid][pSVIPExVoucher] < 1) {
		PlayerInfo[playerid][pBanhTrungThu] -= 10;
		PlayerInfo[playerid][pSVIPExVoucher] ++;
		SendClientMessage(playerid, COLOR_YELLOW, "{66CC66}[Doi Thuong]{EEEEEE} Ban da doi thanh cong mot vip bac 7 ngay");
		}
		else SendClientMessage(playerid, COLOR_GREY, "Ban da doi 1 lan roi khong the doi tiep");
		}
		else SendClientMessage(playerid, COLOR_GREY, "khong the thuc hien do ban khong du 10 Banh trung thu");
		}
		if(listitem == 1)
		{
		if(PlayerInfo[playerid][pBanhTrungThu] > 50){
		PlayerInfo[playerid][pBanhTrungThu] -= 50;
		PlayerInfo[playerid][pGVIPVoucher] ++;
		SendClientMessage(playerid, COLOR_YELLOW, "{66CC66}[Doi Thuong]{EEEEEE} Ban da doi thanh cong mot vip Gold 30 ngay");
		}
		else SendClientMessage(playerid, COLOR_GREY, "khong the thuc hien do ban khong du 50 banh trung thu");
		}
		if(listitem == 2)
		{
		if(PlayerInfo[playerid][pBanhTrungThu] > 50){
		if(PlayerInfo[playerid][pVehVoucher] < 1){
		PlayerInfo[playerid][pBanhTrungThu] -= 50;
		PlayerInfo[playerid][pVehVoucher] ++;
		SendClientMessage(playerid, COLOR_YELLOW, "{66CC66}[Doi Thuong]{EEEEEE} Ban da doi thanh cong mot phieu xe mien phi");
		}
		else SendClientMessage(playerid, COLOR_GREY, "Ban da doi 1 lan roi khong the doi tiep");
		}
		else SendClientMessage(playerid, COLOR_GREY, "khong the thuc hien do ban khong du 50 banh trung thu");
	...
	if(dialogid == DIALOG_TELEJOB)
	{
	    if(response)
	    {
	        if(listitem == 0)
	        {
			if(PlayerInfo[playerid][pTeleJob] > 1) {
			PlayerInfo[playerid][pTeleJob] -= 1;
	        SetPlayerPos(playerid, -1718.90,1355.63,7.18);
	        PlayerInfo[playerid][pTeleJob] -= 1;
	        SendClientMessage(playerid, -1, "{FF0000}[Tin Nhan]{F7F01D}Ban da dich chuyen thanh cong va bi tru di mot luot tele job");
	        }
         	else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong co mot luot tele khong thuc hien");
			}
			if(listitem == 1)
			{
			if(PlayerInfo[playerid][pTeleJob] > 1) {
			PlayerInfo[playerid][pTeleJob] -= 1;
			SetPlayerPos(playerid, -1560.963867,127.491157,3.554687);
 			SendClientMessage(playerid, -1, "{FF0000}[Tin Nhan]{F7F01D}Ban da dich chuyen thanh cong va bi tru di mot luot tele job");
			}
			else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong co mot luot tele khong thuc hien");
 			}
			...
			if(PlayerInfo[playerid][pTeleJob] > 1) {
			PlayerInfo[playerid][pTeleJob] -= 1;
			SetPlayerPos(playerid, -1930.6116,1089.9666,51.2822);
			SendClientMessage(playerid, -1, "{FF0000}[Tin Nhan]{F7F01D}Ban da dich chuyen thanh cong va bi tru di mot luot tele job");
			}
			else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong co mot luot tele khong thuc hien");
         	}
	...
	if(dialogid == DIALOG_CHETAOVUKHI3)
	{
		if(response)
		{
			if(listitem == 0)
			{
			ShowPlayerDialog(playerid, DIALOG_CHETAOVUKHI,  DIALOG_STYLE_LIST, "Ban muon che vu khi nao ?","9mm - 8500Mats\nSILENCED 8500Mats\nDEAGLE 19500Mats", "O", "X");
			}
			if(listitem == 1)
			{
			ShowPlayerDialog(playerid, DIALOG_CHETAOVUKHI1,  DIALOG_STYLE_LIST, "Ban muon che vu khi nao ?","Shotgun 12500Mats\nSHOTGSPA 65000Mats", "O", "X");
			}
			if(listitem == 2)
			{
			ShowPlayerDialog(playerid, DIALOG_CHETAOVUKHI2,  DIALOG_STYLE_LIST, "Ban muon che vu khi nao ?","Mp5 18000Mats\nAk47 65000Mats", "O", "X");
			}
		}
	}
	if(dialogid == DIALOG_CHETAOVUKHI2)
	{
		if(response)
		{
			if(listitem == 0)
			{
				if(PlayerInfo[playerid][pMats] >= 18000) {
				PlayerInfo[playerid][pMats] -= 18000;
				GivePlayerValidWeapon(playerid, 29, 100);
				SendClientMessage(playerid, -1, "{FF0000}[Che Tao]{F7F01D}Ban da che tao thanh cong mot khau sung Mp5");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 18000 vat lieu khong the che tao");
			}
			if(listitem == 1)
			{
				if(PlayerInfo[playerid][pMats] >= 65000) {
				PlayerInfo[playerid][pMats] -= 65000;
				GivePlayerValidWeapon(playerid, 30, 100);
				SendClientMessage(playerid, -1, "{FF0000}[Che Tao]{F7F01D}Ban da che tao thanh cong mot khau sung AK47");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 65000 vat lieu khong the che tao");
			}	
		}
	}
	if(dialogid == DIALOG_CHETAOVUKHI1)
	{
		if(response)
		{
			if(listitem == 0)
			{
				...
				PlayerInfo[playerid][pMats] -= 12500;
				GivePlayerValidWeapon(playerid, 25, 35);
				SendClientMessage(playerid, -1, "{FF0000}[Che Tao]{F7F01D}Ban da che tao thanh cong mot khau sung ShotGun");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 12500 vat lieu khong the che tao");
			}
			if(listitem == 1)
			{
				if(PlayerInfo[playerid][pMats] >= 65000) {
				PlayerInfo[playerid][pMats] -= 65000;
				GivePlayerValidWeapon(playerid, 27, 50);
				SendClientMessage(playerid, -1, "{FF0000}[Che Tao]{F7F01D}Ban da che tao thanh cong mot khau sung SHOTGSPA");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 65000 vat lieu khong the che tao");
			}	
		}
	...
	if(dialogid == DIALOG_CHETAOVUKHI)
	{
		if(response)
		{
			if(listitem == 0)
			{
				if(PlayerInfo[playerid][pMats] >= 8500) {
				PlayerInfo[playerid][pMats] -= 8500;
				GivePlayerValidWeapon(playerid, 22, 50);
				SendClientMessage(playerid, -1, "{FF0000}[Che Tao]{F7F01D}Ban da che tao thanh cong mot khau sung 9mm");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 8500 vat lieu khong the che tao");
			}
			if(listitem == 1)
			{
				if(PlayerInfo[playerid][pMats] >= 8500) {
				PlayerInfo[playerid][pMats] -= 8500;
				GivePlayerValidWeapon(playerid, 23, 50);
				SendClientMessage(playerid, -1, "{FF0000}[Che Tao]{F7F01D}Ban da che tao thanh cong mot khau sung SILENCED");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 8500 vat lieu khong the che tao");
			}	
			if(listitem == 2)
			{
				...
				if(PlayerInfo[playerid][pMats] >= 19500) {
				PlayerInfo[playerid][pMats] -= 19500;
				GivePlayerValidWeapon(playerid, 24, 50);
				SendClientMessage(playerid, -1, "{FF0000}[Che Tao]{F7F01D}Ban da che tao thanh cong mot khau sung Deagle");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 19500 vat lieu khong the che tao");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du cap do 3 khong the che tao");
			}
		}
	}
	if(dialogid == DIALOG_TRAODOI1)
	{
	    if(response)
	    {
	        if(listitem == 0)
	        {
	            ...
	            PlayerInfo[playerid][pDau] -= 20;
				PlayerInfo[playerid][pPot] += 10;
         		SendClientMessage(playerid, -1, "{FF0000}[Trao Doi]{F7F01D}Ban da doi thanh cong 10 Pot (Chat kich thich)");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 20 dau khong the trao doi");
			}
			if(listitem == 1)
			{
	            if(PlayerInfo[playerid][pDau] >= 20) {
				...
				PlayerInfo[playerid][pCrack] += 10;
         		SendClientMessage(playerid, -1, "{FF0000}[Trao Doi]{F7F01D}Ban da doi thanh cong 10 Crack (Chat kich thich)");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 20 dau khong the trao doi");
			}
		}
	...
	if(dialogid == DIALOG_TRAODOI)
 	{
		if(response)
		{
		    if(listitem == 0)
		    {
				if(PlayerInfo[playerid][pDau] >= 35) {
				PlayerInfo[playerid][pDau] -= 35;
				GivePlayerValidWeapon(playerid, 29, 150);
				SendClientMessage(playerid, -1, "{FF0000}[Trao Doi]{F7F01D}Ban da doi thanh cong Mot khau sng mp5");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 35 dau khong the trao doi");
			}
			if(listitem == 1)
			{
			    if(PlayerInfo[playerid][pDau] >= 65) {
			    PlayerInfo[playerid][pDau] -= 65;
                GivePlayerValidWeapon(playerid, 24, 50);
                SendClientMessage(playerid, -1, "{FF0000}[Trao Doi]{F7F01D}Ban da doi thanh cong mot khau Deagle");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 65 dau khong the trao doi");
			}
			if(listitem == 2)
			{
			    if(PlayerInfo[playerid][pDau] >= 25) {
			    PlayerInfo[playerid][pDau] -= 25;
                GivePlayerValidWeapon(playerid, 25, 40);
       			SendClientMessage(playerid, -1, "{FF0000}[Trao Doi]{F7F01D}Ban da doi thanh cong mot khau ShotGun");
				}
				else SendClientMessage(playerid, -1, "{FF0000}[Eror]{585858}Ban khong du 25 dau khong the trao doi");
			}
			if(listitem == 3)
			{
				ShowPlayerDialog(playerid, DIALOG_TRAODOI1, DIALOG_STYLE_LIST, "Trao doi", "Pot\nCrack", "O", "X");
			}
		}
	}
    if(dialogid == DIALOG_TRUNGTAMXINVIEC)
    {
        if(response)
        {
            if(listitem == 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_XINVIEC, DIALOG_STYLE_MSGBOX, "Nhan Viec", "Ban Co Muon Nhan Cong Viec Nay Khong", "O", "X");
	...
	if(dialogid == DIALOG_XINVIEC)
	{
                ...
                SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "Ban Da nhan mot cong viec /help de xem cac lenh.");
                ...
                if(GettingJob[playerid] == 21) {
                	SendClientMessageEx(playerid, COLOR_WHITE, "Ban da nhan mot cong viec giao thuc an nhann - nhan duoc mot bo dong phuc");
                ...
                SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "Ban Da nhan mot cong viec /help de xem cac lenh");
                SendClientMessageEx(playerid, COLOR_YELLOW, "[VIP] Ban Co Vip Va Nhan Them Mot Cong Viec Phu");
                ...
                SendClientMessageEx(playerid, COLOR_GREY, "Ban Khong o vi tri nhan viec");
                return 1;
            }
        }
	...
	if(dialogid == CAUHOINEWB)
	{
			if(response) {
				...
				new string[128];
				strcpy(CauHoiNewb[playerid], inputtext, 128);
				format(string, sizeof(string), "** %s(%i) da gui mot cau hoi Den Ho Tro Vien. (su dung /dap De Ho Tro %i)", GetPlayerNameEx(playerid), playerid, playerid);
				...
				SendClientMessageEx(playerid, COLOR_WHITE, "Ban da dat cau hoi thanh cong Hay doi Ho tro vien tra loi!");
	...
	if(dialogid == TRALOICAUHOI)
	{
			if(response) {
				...
				format(stri, sizeof(stri), "** [ID:%d]{CCCC33}Newbie %s {770000}hoi: %s.", reportid, GetPlayerNameEx(reportid), advert);
				format(string1, sizeof(string1), "** [ID:%d]{99FFFF} Ho Tro Vien %s tra loi:{0099FF} %s.", playerid, GetPlayerNameEx(playerid), inputtext);
	...
	if(dialogid == NONGDAN)
    {
        if(response)
        {
            if(listitem == 0)
            {
                SetPlayerCheckpoint(playerid, 237.1064,1155.4343,12.6078, 5);
				SendClientMessage(playerid, -1, "Khi Den Khu Vuc Hai Rau Hay /thuhoach De Bat Dau Cong Viec");
                CP[playerid] = 1;
            }
            else if(listitem == 1) 
            {
                SetPlayerCheckpoint(playerid, -489.1620,610.9698,1.7739, 5);
				SendClientMessage(playerid, -1, "Khi Den Khu Lam Sach Hay Bam (Y)");
                CP[playerid] = 1;
            }
            else if(listitem == 2)
            {
            	SetPlayerCheckpoint(playerid,-214.2878,1091.5020,19.7422, 5);
                SendClientMessage(playerid, -1, "Kh Den Quay Ban Hang Hay Bam (Y)");
	...
	if(dialogid == CHATGO)
    {
        if(response)
        {
            if(listitem == 0)
            {
                SetPlayerCheckpoint(playerid, -1790.5878,1429.7802,7.1841, 5);
				SendClientMessage(playerid, -1, "Khi Den Noi Hay /layxecongviec De Bat Dau Cong Viec Nhe!");
                CP[playerid] = 1;
            }
            else if(listitem == 1) 
            {
                SetPlayerCheckpoint(playerid, -1455.5834,-1416.2548,101.7892, 5);
				SendClientMessage(playerid, -1, "Khi Den Noi Chat Go Hay /chatgo De Lay Go Va Dem Ban Cho Nha May!");
                CP[playerid] = 1;
            }
            else if(listitem == 2)
            {
                SetPlayerCheckpoint(playerid, -1581.8700,1276.1106,7.1788, 5);
                CP[playerid] = 2;
	...
	if(dialogid == CANSA)
    {
        if(response)
        {
            if(listitem == 0)
            {
                SetPlayerCheckpoint(playerid, -752.0267,-155.4852,66.7585, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 1)
            {
                SetPlayerCheckpoint(playerid, -732.8764,1546.1532,38.9959, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 2)
            {
                SetPlayerCheckpoint(playerid, -692.0992,939.6012 ,13.6328, 5);
                CP[playerid] = 2;
            }
            else if(listitem == 3)
            {
                SetPlayerCheckpoint(playerid, -380.8940,1113.2659,19.6427, 1);
                CP[playerid] = 2;
            }
        }
    }
    if(dialogid == VITRITHUEXE)
    {
        if(response)
		{
			if(listitem == 0)//bv
			{
				...
				SetPlayerCheckpoint(playerid, -2640.9512,614.0588,14.4531, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 2) //pizza
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1710.0415,1336.1165,7.1843, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
		}
    ...
    if(dialogid == TIMDUONG)
	{
	    if(response)
	    {
		    ...
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -203.9019,1182.9662,19.7422, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
	       	if(listitem == 1) // 24/7
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -145.6262,1173.2472,19.7422, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 2) //Bank
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -176.6956,1112.1431,19.7422, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
		    if(listitem == 3) //DMV
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -179.7113,1177.7839,19.8909, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 4) //HQ TAXI
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -168.1590,1032.1339,19.7344, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 5) //Quan Ao
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -127.12,1188.41,19.74, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 6) //Bv
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -320.5106,1058.1903,19.7422, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 7) //Vu khi
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -53.7371,1189.6859,19.3594, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 8) //shop xe
		    {
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, 1656.34,-1027.87,23.89, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
		}
	...
	if(dialogid == TIMVIECLAM)
    {
        if(response)
        {
            ...
            if(listitem == 0)// Nong dan
            {
                return cmd_nongdan(playerid, "");
//				PlayerPlaySound(playerid,1149,0.0,0.0,0.0);
            }
            else if(listitem == 1)// Giao Hang (TR)
            {
                SetPlayerCheckpoint(playerid, -1316.7323,2700.7727,50.2663, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 2)// Gai diem (LS)
            {
                SetPlayerCheckpoint(playerid, 1877.8519,-1627.8912,13.3346, 5);
                CP[playerid] = 2;
            }
            else if(listitem == 3)// Buon thuoc phien (LS)
            {
                SetPlayerCheckpoint(playerid, -153.6690,879.3754,18.3652, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 4)// Tho sua xe (LS)
            {
                SetPlayerCheckpoint(playerid, -94.9299,1108.6356,19.7422, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 5)// Ve si (LS)
            {
                SetPlayerCheckpoint(playerid, 105.8922,1185.7015,19.7422, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 6)// Buon vu khi (LS)
            {
                SetPlayerCheckpoint(playerid, -52.5288,1190.3461,19.3594, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 7)// Boxer (LS)
            {
                SetPlayerCheckpoint(playerid, 766.0273,14.1984,1000.7010, 5);
                CP[playerid] = 2;
            }

            else if(listitem == 8)// Buon ma tuy (LS)
            {
                SetPlayerCheckpoint(playerid, 2354.3938,-1169.4385,28.0138, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 9)// Tai xe Taxi (LS)
            {
                SetPlayerCheckpoint(playerid, -179.8376,1022.4993,19.7422, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 10)// Tho thu cong (LS)
            {
                SetPlayerCheckpoint(playerid, -123.4430,1081.2023,19.7742, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 11)// Tho pha che (LS)
            {
                SetPlayerCheckpoint(playerid, 1837.0396,-1682.3752,13.3228, 5);
                CP[playerid] = 2;
            }
            else if(listitem == 12)// Trucker (LS)
            {
                SetPlayerCheckpoint(playerid, -1561.47,127.97,3.55, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 13)// Pizza boy (LS)
            {
                SetPlayerCheckpoint(playerid, -1718.90,1355.63,7.18, 5);
                CP[playerid] = 1;
            }
            else if(listitem == 14)// thothucong (TR)
            {
                SetPlayerCheckpoint(playerid, -1512.2278,2611.8994,55.7666, 5);
                CP[playerid] = 1;
            }
	...
	if(RegistrationStep[playerid] != 0 || strcmp(PlayerInfo[playerid][pBirthDate], "0000-00-00", true) == 0)
	{
		...
		else if(dialogid == REGISTERYEAR)
	    {
			...
			if(response)
			{
				...
				if(RegistrationStep[playerid] != 0)
				{
					ShowPlayerDialog(playerid, REGISTERREF, DIALOG_STYLE_INPUT, "{FF0000}Cong dong GTA Viet Roleplay (Mobile) He Thong Gioi Thieu Nguoi Choi Moi ", "- Ban da duoc gioi thieu boi mot nguoi nao do?\n- Neu vay, ban hay nhap ten nguoi choi vao duoi day.\n\n- Neu ban da khong duoc de cap boi bat cu ai, ban co the nhan nut {FF0000}Bo qua{FFFFFF}.\n\n{FF0000}Luu Y: Ban phai nhap ten nguoi choi voi mot dau gach duoi (VD: Nguyen_Duy)", "Dong y", "Bo qua");
				}
		...
		else if(dialogid == REGISTERREF)
		{
		    if(response)
		    {
		        ...
		        {
		            ShowPlayerDialog(playerid, REGISTERREF, DIALOG_STYLE_INPUT, "{FF0000}Cong dong GTA Viet Roleplay (Mobile) - Ten khong hop le Roleplay", "- Do khong phai la mot ten roleplay\n- Hay nhap ten roleplay thich hop.\n\n- Neu ban da khong duoc de cap boi bat cu ai, ban co the nhan nut {FF0000}Bo qua{FFFFFF}.\n\n- VD: ho_ten", "Dong y", "Bo qua");
		            return 1;
				}
		        ...
		        {
		            ShowPlayerDialog(playerid, REGISTERREF, DIALOG_STYLE_INPUT, "{FF0000}Cong dong GTA Viet Roleplay (Mobile) - Ten khong hop le Roleplay", "- Ten ma ban gioi thieu qua dai\n- Hay nhap ten ngan.\n\n- Neu ban da khong duoc de cap boi bat cu ai, ban co the nhan nut {FF0000}Bo qua{FFFFFF}\n\n- VD: ho_ten (20 Characters Max)", "Dong y", "Bo qua");
		            return 1;
		        }
		        if(strcmp(inputtext, GetPlayerNameExt(playerid), true) == 0)
		        {
		            ShowPlayerDialog(playerid, REGISTERREF, DIALOG_STYLE_INPUT, "{FF0000}Cong dong GTA Viet Roleplay (Mobile)", "- Ban khong the nhap ten cua ban de gioi thieu.\n- Hay nhap ten nguoi gioi thieu thieu hoac nhan' 'Bo qua'.\n\n- VD: ho_ten (20 Characters Max)", "Dong y", "Bo qua");
		            return 1;
		        }
	...
	switch(dialogid)
	{
		...
		case G_LOCKER_EQUIPMENT: if(response)
		{
			new	iGroupID = PlayerInfo[playerid][pMember];
			{
				...
				GivePlayerValidWeapon(playerid, iGunID, 60000);
			}
		}
	...
	if(dialogid == VIPWEPSMENU)
	{
	    ...
	    switch( listitem )
	    {
	        case 0:
	        {
				...
				GivePlayerValidWeapon(playerid, 24, 200);
	        }
	        case 1:
	        {
				...
				GivePlayerValidWeapon(playerid, 25, 200);
	        }
	        case 2:
	        {
 				if(PlayerInfo[playerid][pDonateRank] < 3)
				...
				GivePlayerValidWeapon(playerid, 29, 200);
	        }
	        case 3:
	        {
 				if(PlayerInfo[playerid][pDonateRank] < 3)
                ...
                GivePlayerValidWeapon(playerid, 23, 200);
	        }
	        case 4:
	        {
 				if(PlayerInfo[playerid][pDonateRank] < 3)
	...
	if(dialogid == 7483) // VIP Locker /viplocker
	{
		if(response)
		{
			if(listitem == 0)
			{
				...
				SendClientMessageEx(playerid, COLOR_YELLOW, "VIP: Ban da su dung mot tui cuu thuong, bay gio ban co 70.0 HP.");
			}
			if(listitem == 1)
			{
				new Float:armour;
			...
			if(listitem == 2)
			{
				if(PlayerInfo[playerid][pDonateRank] >= 1)
				{ 
				if(PlayerInfo[playerid][pGiayPhepVuKhi] >= 1)
				{
				...
				{
					SendClientMessageEx(playerid, COLOR_YELLOW, "Ban can phai co giay phep moi co the lay sung");
				}
				}
				else
					SendClientMessage(playerid, COLOR_YELLOW, "VIP: Ban phai la thanh vien VIP moi co the truy cap vao tu do sung VIP.");
				}
			if(listitem == 3)
			{
            	if(PlayerInfo[playerid][pDonateRank] >= 2)
	...
	if(dialogid == 7485)
	{
	    ...
	    switch(listitem)
	    {
	        case 0:
	        {
	        	...
	        	SendClientMessageEx(playerid, -1, "Ban da thay doi cong viec dau tien cua minh!");
			}
	        case 1:
			{
		 		PlayerInfo[playerid][pJob2] = GetPVarInt(playerid, "jobSelection");
		 		SendClientMessageEx(playerid, -1, "Ban da thay doi cong viec thu hai cua minh!");
			}
	    }
	}
	if(dialogid == 7486)
	{
	    ...
	    switch(listitem)
	    {
			...
			{
		 		SetPlayerToTeamColor(playerid);
		 		SendClientMessageEx(playerid, -1, "Ban da tat mau nick VIP!");
			}
	    }
	}
	...
	else if(dialogid == DIALOG_LOADTRUCKOLD) // TRUCKER JOB LOAD TRUCK
	{
 		if(response)
		{
			...
			if(listitem == 1) // Illegal goods
			{
				...
				{
            		ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 1 Bonus: Free Bat)\n{FF0606}Ma tuy  		{FFFFFF}(Level 1 Bonus: Free 1 pot, 1 crack)\n{FF0606}Vat lieu        {FFFFFF}(Level 1 Bonus: Free 100 vl)", "Lua chon", "Thoat");
				}
				else if(level >= 151 && level <= 300)
				{
		    		ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 2 Bonus: Free katana)\n{FF0606}Ma tuy  		{FFFFFF}(Level 2 Bonus: Free 2 pot, 2 crack)\n{FF0606}Vat lieu        {FFFFFF}(Level 2 Bonus: Free 200 vl)", "Lua chon", "Thoat");
				}
				else if(level >= 300 && level <= 450)
				{
		    		ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 3 Bonus: Free GOLFCLUB)\n{FF0606}Ma tuy  		{FFFFFF}(Level 3 Bonus: Free 3 pot, 3 crack)\n{FF0606}Vat lieu  		{FFFFFF}(Level 3 Bonus: Free 300 vl)", "Lua chon", "Thoat");
				}
				else if(level >= 450 && level <= 550)
				{
            		ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 4 Bonus: Free SHOVEL)\n{FF0606}Ma tuy  		{FFFFFF}(Level 4 Bonus: Free 5 pot, 5 crack)\n{FF0606}Vat lieu  		{FFFFFF}(Level 4 Bonus: Free 400 vl)", "Lua chon", "Thoat");
				}
				else if(level >= 700)
				{
 		 			ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 5 Bonus: Free Sex toy)\n{FF0606}Ma tuy  		{FFFFFF}(Level 5 Bonus: Free 10 pot, 10 crack)\n{FF0606}Vat lieu  		{FFFFFF}(Level 5 Bonus: Free 1000 vl)", "Lua chon", "Thoat");
				}
			}
		}
		else
			...
			if(InvalidModCheck(GetVehicleModel(GetPlayerVehicleID(playerid)), 1025))
			{
                for(new d = 0 ; d < MAX_PLAYERVEHICLES; d++)
				{
					if(IsPlayerInVehicle(playerid, PlayerVehicleInfo[playerid][d][pvId]))
					{
						...
						SendClientMessageEx(playerid,  -1, "Ban da modded rims thanh  cong.");
	...
	if(dialogid == DISPLAY_STATS)
	{
		...
		if(IsPlayerConnected(targetid))
		{
			if(response)
			{
				...
				format(resultline, sizeof(resultline),"{FFFFFF}Truy na cap: %d\n\
				Toi pham: %s\n\
				Bat giu: %s\n\
