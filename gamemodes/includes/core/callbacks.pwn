...
public OnPlayerUpdate(playerid)
{
	...
	format(young,sizeof(young),"ID: %d",playerid);
 	PlayerTextDrawSetString(playerid,LogoTD[0],young);
 	format(young,sizeof(young),"Level: %d",PlayerInfo[playerid][pLevel]);
 	PlayerTextDrawSetString(playerid,LogoTD[1],young);*/
    new string[256];
	/*format(string, sizeof(string), "%d", PlayerInfo[playerid][pLevel]);
	PlayerTextDrawSetString(playerid, kontenTD[playerid][4], string);*/

	/*format(string, sizeof(string), "%d", PlayerInfo[playerid][pCash]);
	PlayerTextDrawSetString(playerid, Money[playerid], string);*/
	
	/*format(string, sizeof(string), "%d", PlayerInfo[playerid][pExp]);
	PlayerTextDrawSetString(playerid, kontenTD[playerid][6], string);*/
	
	if(IsACop(playerid) || !IsAMedic(playerid)){
	 new string[200];
    format(string, sizeof(string), "Cong Dan", playerid);
    SetPlayerChatBubble(playerid,string,COLOR_LIGHTBLUE,100.0,10000);
	}
  if(IsAMedic(playerid)){
	 new string[200];
    format(string, sizeof(string), "Nhan Vien Y Te", playerid);
    SetPlayerChatBubble(playerid,string,COLOR_RED,100.0,10000);
	}
	if(IsACop(playerid)){
	 new string[200];
    format(string, sizeof(string), "Cong An Nhan Dan", playerid);
    SetPlayerChatBubble(playerid,string,COLOR_GREEN,100.0,10000);
	}
...
{
// add ở public OnPlayerClickMap(playerid, Float:fX, Float:fY, Float:fZ)
    if(PlayerInfo[playerid][pAdmin] >= 7)
    {
        SetPlayerPosFindZ(playerid, fX, fY, fZ);
        SendClientMessage(playerid, COLOR_CYAN, "ban da dich chuyen den vi tri chi dinh.");
    }
	...
	for(new Sz; Sz < MAX_SZ; Sz++)
	{
		...
		{//if Player outside safe zone and damagedid inside safe zone
			if(IsPlayerInRangeOfPoint(damagedid, SafeZoneInfo[Sz][szSize], SafeZoneInfo[Sz][szPosX], SafeZoneInfo[Sz][szPosY], SafeZoneInfo[Sz][szPosZ]))
			{
				if(!IsPlayerAdmin(playerid))
				{
					GameTextForPlayer(playerid, "~y~ean dang o trong khu an toan", 1000, 3);
				}
			}
		}
	}
...
public OnPlayerEnterVehicle(playerid, vehicleid, ispassenger)
{
	...
	if(!ispassenger)
	{
		...
		else if(IsAThuyenNguDan(vehicleid))
		{
		    if(PlayerInfo[playerid][pJob] != 5 && PlayerInfo[playerid][pJob2] != 5)
		    {
			    ...
			    RemovePlayerFromVehicle(playerid);
			    defer NOPCheck(playerid);
			    SendClientMessageEx(playerid, COLOR_GRAD2, "Ban khong phai ngu dan!");
			}
		}

		
		else if(IsAXeVeSinh(vehicleid))
		{
		    if(PlayerInfo[playerid][pJob] != 6 && PlayerInfo[playerid][pJob2] != 6)
		    {
			    ...
			    RemovePlayerFromVehicle(playerid);
			    defer NOPCheck(playerid);
			    SendClientMessageEx(playerid, COLOR_GRAD2, "Ban khong phai la nhan vien ve sinh!");
			}
		}
		...
		else if(IsATruckerCar(vehicleid))
		{
		    if((PlayerInfo[playerid][pJob] == 1 || PlayerInfo[playerid][pJob2] == 1))
			{
				...
				{
    				SendClientMessageEx(playerid, COLOR_YELLOW, "De Lay Hang ban hay bam nut Y.");
				}
...
public OnPlayerConnect(playerid) {
	...
	PlayerTD[playerid][0] = CreatePlayerTextDraw(playerid, 557.000000, 330.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][0], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][0], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][0], 83.000000, 73.500000);
	...
	Money[playerid] = CreatePlayerTextDraw(playerid, 574.000000, 336.000000, "RP.9000000000");
	PlayerTextDrawFont(playerid, Money[playerid], 1);
	PlayerTextDrawLetterSize(playerid, Money[playerid], 0.154164, 1.049998);
	...
	PlayerTextDrawColor(playerid, Money[playerid], 16711935);
	...
	PlayerTD[playerid][1] = CreatePlayerTextDraw(playerid, 563.000000, 354.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][1], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][1], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][1], 10.000000, 5.500000);
	...
	PlayerTD[playerid][2] = CreatePlayerTextDraw(playerid, 557.000000, 349.000000, "ld_beat:chit");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][2], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][2], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][2], 21.500000, 10.000000);
	...
	PlayerTD[playerid][3] = CreatePlayerTextDraw(playerid, 565.000000, 353.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][3], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][3], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][3], 1.000000, 6.500000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][3], -764862721);
	...
	PlayerTD[playerid][4] = CreatePlayerTextDraw(playerid, 567.000000, 353.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][4], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][4], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][4], 1.000000, 6.500000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][4], -764862721);
	...
	PlayerTD[playerid][5] = CreatePlayerTextDraw(playerid, 569.000000, 353.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][5], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][5], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][5], 1.000000, 6.500000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][5], -764862721);
	...
	PlayerTD[playerid][6] = CreatePlayerTextDraw(playerid, 563.000000, 364.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][6], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][6], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][6], 8.500000, 11.500000);
	...
	PlayerTD[playerid][7] = CreatePlayerTextDraw(playerid, 564.000000, 366.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][7], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][7], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][7], 6.500000, 8.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][7], 1687547391);
	...
	PlayerTD[playerid][8] = CreatePlayerTextDraw(playerid, 563.000000, 382.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][8], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][8], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][8], 3.000000, 7.500000);
	...
	PlayerTD[playerid][9] = CreatePlayerTextDraw(playerid, 563.000000, 388.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][9], 4);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][9], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][9], 9.500000, 5.000000);
	...
	PlayerTD[playerid][10] = CreatePlayerTextDraw(playerid, 561.000000, 388.000000, "ld_beat:chit");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][10], 13.500000, 8.500000);
	...
	PlayerTD[playerid][11] = CreatePlayerTextDraw(playerid, 566.000000, 397.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][11], 4.500000, 1.500000);
	...
	PlayerTD[playerid][12] = CreatePlayerTextDraw(playerid, 578.000000, 351.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][12], 61.500000, 9.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][12], 150);
	...
	PlayerTD[playerid][13] = CreatePlayerTextDraw(playerid, 578.000000, 366.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][13], 61.500000, 9.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][13], 150);
	...
	PlayerTD[playerid][14] = CreatePlayerTextDraw(playerid, 578.000000, 385.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][14], 61.500000, 9.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][14], 150);
	...
	HungerHUD[playerid] = CreatePlayerTextDraw(playerid, 578.000000, 351.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, HungerHUD[playerid], 4);
	PlayerTextDrawLetterSize(playerid, HungerHUD[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HungerHUD[playerid], 61.500000, 9.000000);
	PlayerTextDrawSetOutline(playerid, HungerHUD[playerid], 1);
	PlayerTextDrawSetShadow(playerid, HungerHUD[playerid], 0);
	PlayerTextDrawAlignment(playerid, HungerHUD[playerid], 1);
	PlayerTextDrawColor(playerid, HungerHUD[playerid], 16711935);
	PlayerTextDrawBackgroundColor(playerid, HungerHUD[playerid], 255);
	PlayerTextDrawBoxColor(playerid, HungerHUD[playerid], 50);
	PlayerTextDrawUseBox(playerid, HungerHUD[playerid], 1);
	PlayerTextDrawSetProportional(playerid, HungerHUD[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, HungerHUD[playerid], 0);

	HausHUD[playerid] = CreatePlayerTextDraw(playerid, 578.000000, 366.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, HausHUD[playerid], 4);
	PlayerTextDrawLetterSize(playerid, HausHUD[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HausHUD[playerid], 61.500000, 9.000000);
	PlayerTextDrawSetOutline(playerid, HausHUD[playerid], 1);
	PlayerTextDrawSetShadow(playerid, HausHUD[playerid], 0);
	PlayerTextDrawAlignment(playerid, HausHUD[playerid], 1);
	PlayerTextDrawColor(playerid, HausHUD[playerid], 1687547391);
	PlayerTextDrawBackgroundColor(playerid, HausHUD[playerid], 255);
	PlayerTextDrawBoxColor(playerid, HausHUD[playerid], 50);
	PlayerTextDrawUseBox(playerid, HausHUD[playerid], 1);
	PlayerTextDrawSetProportional(playerid, HausHUD[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, HausHUD[playerid], 0);

	NguyuhHUD[playerid] = CreatePlayerTextDraw(playerid, 578.000000, 385.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, NguyuhHUD[playerid], 4);
	PlayerTextDrawLetterSize(playerid, NguyuhHUD[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, NguyuhHUD[playerid], 61.500000, 9.000000);
	PlayerTextDrawSetOutline(playerid, NguyuhHUD[playerid], 1);
	PlayerTextDrawSetShadow(playerid, NguyuhHUD[playerid], 0);
	PlayerTextDrawAlignment(playerid, NguyuhHUD[playerid], 1);
	PlayerTextDrawColor(playerid, NguyuhHUD[playerid], -2686721);
	PlayerTextDrawBackgroundColor(playerid, NguyuhHUD[playerid], 255);
	PlayerTextDrawBoxColor(playerid, NguyuhHUD[playerid], 50);
	PlayerTextDrawUseBox(playerid, NguyuhHUD[playerid], 1);
	PlayerTextDrawSetProportional(playerid, NguyuhHUD[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, NguyuhHUD[playerid], 0);

	PlayerTD[playerid][15] = CreatePlayerTextDraw(playerid, 595.000000, 350.000000, "HUNGER");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][15], 1);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][15], 0.154164, 1.049998);
	...
	PlayerTD[playerid][16] = CreatePlayerTextDraw(playerid, 596.000000, 365.000000, "THIRST");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][16], 1);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][16], 0.154164, 1.049998);
	...
	PlayerTD[playerid][17] = CreatePlayerTextDraw(playerid, 596.000000, 384.000000, "TOILET");
	PlayerTextDrawFont(playerid, PlayerTD[playerid][17], 1);
	PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][17], 0.154164, 1.049998);
	...
	PlayerTD[playerid][18] = CreatePlayerTextDraw(playerid, 481.000000, 406.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][18], 66.000000, 13.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][18], 150);
	...
	DarahVeh[playerid] = CreatePlayerTextDraw(playerid, 482.000000, 407.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, DarahVeh[playerid], 4);
	PlayerTextDrawLetterSize(playerid, DarahVeh[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, DarahVeh[playerid], 64.000000, 11.000000);
	PlayerTextDrawSetOutline(playerid, DarahVeh[playerid], 1);
	PlayerTextDrawSetShadow(playerid, DarahVeh[playerid], 0);
	PlayerTextDrawAlignment(playerid, DarahVeh[playerid], 1);
	PlayerTextDrawColor(playerid, DarahVeh[playerid], -16776961);
	PlayerTextDrawBackgroundColor(playerid, DarahVeh[playerid], 255);
	PlayerTextDrawBoxColor(playerid, DarahVeh[playerid], 50);
	PlayerTextDrawUseBox(playerid, DarahVeh[playerid], 1);
	PlayerTextDrawSetProportional(playerid, DarahVeh[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, DarahVeh[playerid], 0);

	PlayerTD[playerid][19] = CreatePlayerTextDraw(playerid, 481.000000, 422.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][19], 66.000000, 13.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][19], 150);
	...
	VehFuel[playerid] = CreatePlayerTextDraw(playerid, 482.000000, 423.000000, "ld_bum:blkdot");
	PlayerTextDrawFont(playerid, VehFuel[playerid], 4);
	PlayerTextDrawLetterSize(playerid, VehFuel[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, VehFuel[playerid], 64.000000, 11.000000);
	PlayerTextDrawSetOutline(playerid, VehFuel[playerid], 1);
	PlayerTextDrawSetShadow(playerid, VehFuel[playerid], 0);
	PlayerTextDrawAlignment(playerid, VehFuel[playerid], 1);
	PlayerTextDrawColor(playerid, VehFuel[playerid], 548580095);
	PlayerTextDrawBackgroundColor(playerid, VehFuel[playerid], 255);
	PlayerTextDrawBoxColor(playerid, VehFuel[playerid], 50);
	PlayerTextDrawUseBox(playerid, VehFuel[playerid], 1);
	PlayerTextDrawSetProportional(playerid, VehFuel[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, VehFuel[playerid], 0);

	PlayerTD[playerid][20] = CreatePlayerTextDraw(playerid, 463.000000, 406.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][20], 15.000000, 13.000000);
	...
	PlayerTD[playerid][21] = CreatePlayerTextDraw(playerid, 463.000000, 422.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][21], 15.000000, 13.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][21], 1296911871);
	...
	PlayerTD[playerid][22] = CreatePlayerTextDraw(playerid, 468.000000, 408.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][22], 8.000000, 8.000000);
	...
	PlayerTD[playerid][23] = CreatePlayerTextDraw(playerid, 471.000000, 410.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][23], 1.000000, 7.500000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][23], 1296911871);
	...
	PlayerTD[playerid][24] = CreatePlayerTextDraw(playerid, 466.000000, 408.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][24], 3.000000, 5.500000);
	...
	PlayerTD[playerid][25] = CreatePlayerTextDraw(playerid, 464.000000, 411.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][25], 3.000000, 0.500000);
	...
	PlayerTD[playerid][26] = CreatePlayerTextDraw(playerid, 464.000000, 408.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][26], 0.500000, 4.500000);
	...
	PlayerTD[playerid][27] = CreatePlayerTextDraw(playerid, 474.000000, 411.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][27], 3.000000, 0.500000);
	...
	PlayerTD[playerid][28] = CreatePlayerTextDraw(playerid, 477.000000, 409.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][28], 0.500000, 4.500000);
	...
	PlayerTD[playerid][29] = CreatePlayerTextDraw(playerid, 467.000000, 423.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][29], 7.500000, 11.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][29], -16776961);
	...
	PlayerTD[playerid][30] = CreatePlayerTextDraw(playerid, 464.000000, 423.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][30], 3.000000, 3.000000);
	...
	PlayerTD[playerid][31] = CreatePlayerTextDraw(playerid, 468.000000, 425.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][31], 6.000000, 7.500000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][31], -1962934017);
	...
	PlayerTD[playerid][32] = CreatePlayerTextDraw(playerid, 476.000000, 426.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][32], 0.500000, 5.500000);
	...
	PlayerTD[playerid][33] = CreatePlayerTextDraw(playerid, 423.000000, 406.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][33], 15.000000, 13.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][33], 1296911871);
	...
	PlayerTD[playerid][34] = CreatePlayerTextDraw(playerid, 423.000000, 422.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][34], 15.000000, 13.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][34], 1296911871);
	...
	PlayerTD[playerid][35] = CreatePlayerTextDraw(playerid, 426.000000, 410.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][35], 8.000000, 2.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][35], -16776961);
	...
	PlayerTD[playerid][36] = CreatePlayerTextDraw(playerid, 429.000000, 406.000000, "ld_beat:chit");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][36], 10.500000, 8.500000);
	...
	PlayerTD[playerid][37] = CreatePlayerTextDraw(playerid, 426.000000, 412.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][37], 1.500000, 3.000000);
	...
	PlayerTD[playerid][38] = CreatePlayerTextDraw(playerid, 421.000000, 421.000000, "ld_beat:chit");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][38], 17.500000, 15.500000);
	...
	PlayerTD[playerid][39] = CreatePlayerTextDraw(playerid, 423.000000, 424.000000, "ld_beat:chit");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][39], 13.500000, 11.500000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][39], 1296911871);
	...
	PlayerTD[playerid][40] = CreatePlayerTextDraw(playerid, 427.000000, 429.000000, "ld_beat:chit");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][40], 5.000000, 4.500000);
	...
	PlayerTD[playerid][41] = CreatePlayerTextDraw(playerid, 429.000000, 430.000000, "ld_bum:blkdot");
	...
	PlayerTextDrawTextSize(playerid, PlayerTD[playerid][41], 1.000000, -6.000000);
	...
	PlayerTextDrawColor(playerid, PlayerTD[playerid][41], -16776961);
   ...
   Gtaaepro0 = TextDrawCreate(248.000000, 430.000000, "11/12/2021");
   TextDrawBackgroundColor(Gtaaepro0, 255);
   TextDrawFont(Gtaaepro0, 0);
   TextDrawLetterSize(Gtaaepro0, 0.500000, 1.000000);
   TextDrawColor(Gtaaepro0, -1);
   TextDrawSetOutline(Gtaaepro0, 0);
   TextDrawSetProportional(Gtaaepro0, 1);
   TextDrawSetShadow(Gtaaepro0, 1);
   TextDrawSetSelectable(Gtaaepro0, 0);

   Gtaaepro1 = TextDrawCreate(319.000000, 429.000000, "-");
   TextDrawBackgroundColor(Gtaaepro1, 255);
   TextDrawFont(Gtaaepro1, 0);
   TextDrawLetterSize(Gtaaepro1, 0.500000, 1.000000);
   TextDrawColor(Gtaaepro1, -1);
   TextDrawSetOutline(Gtaaepro1, 0);
   TextDrawSetProportional(Gtaaepro1, 1);
   TextDrawSetShadow(Gtaaepro1, 1);
   TextDrawSetSelectable(Gtaaepro1, 0);

   Gtaaepro2 = TextDrawCreate(330.000000, 430.000000, "24:00");
   TextDrawBackgroundColor(Gtaaepro2, 255);
   TextDrawFont(Gtaaepro2, 0);
   TextDrawLetterSize(Gtaaepro2, 0.500000, 1.000000);
   TextDrawColor(Gtaaepro2, -1);
   TextDrawSetOutline(Gtaaepro2, 0);
   TextDrawSetProportional(Gtaaepro2, 1);
   TextDrawSetShadow(Gtaaepro2, 1);
   TextDrawSetSelectable(Gtaaepro2, 0);

/*   Gtaaepro3 = TextDrawCreate(478.000000, 12.000000, "VNG-RP");
   TextDrawBackgroundColor(Gtaaepro3, 255);
   TextDrawFont(Gtaaepro3, 1);
   TextDrawLetterSize(Gtaaepro3, 0.500000, 1.000000);
   TextDrawColor(Gtaaepro3, -65281);
   TextDrawSetOutline(Gtaaepro3, 0);
   TextDrawSetProportional(Gtaaepro3, 1);
   TextDrawSetShadow(Gtaaepro3, 1);
   TextDrawUseBox(Gtaaepro3, 1);
   TextDrawBoxColor(Gtaaepro3, 255);
   TextDrawTextSize(Gtaaepro3, 571.000000, 589.000000);
   TextDrawSetSelectable(Gtaaepro3, 0);*/
	
	
/*   kontenTD[playerid][0] = CreatePlayerTextDraw(playerid, 23.411453, 432.666900, "100");
	PlayerTextDrawFont(playerid, kontenTD[playerid][0], 2);
	PlayerTextDrawLetterSize(playerid, kontenTD[playerid][0], 0.001404, 0.970134);
	PlayerTextDrawTextSize(playerid, kontenTD[playerid][0], 0.000000, 27.000000);
	PlayerTextDrawSetOutline(playerid, kontenTD[playerid][0], 0);
	...
	PlayerTextDrawBoxColor(playerid, kontenTD[playerid][0], -56286977);
	...
	kontenTD[playerid][1] = CreatePlayerTextDraw(playerid, 64.172798, 433.250122, "100");
	PlayerTextDrawFont(playerid, kontenTD[playerid][1], 1);
	PlayerTextDrawLetterSize(playerid, kontenTD[playerid][1], -0.000468, 0.935136);
	PlayerTextDrawTextSize(playerid, kontenTD[playerid][7], 0.000000, 38.000000);
	PlayerTextDrawSetOutline(playerid, kontenTD[playerid][1], 0);
	...
	PlayerTextDrawBoxColor(playerid, kontenTD[playerid][1], -56286977);
	PlayerTextDrawUseBox(playerid, kontenTD[playerid][1], 1);
	PlayerTextDrawSetProportional(playerid, kontenTD[playerid][1], 1);
	PlayerTextDrawSetSelectable(playerid, kontenTD[playerid][1], 1);*/

/*		LogoTD[0] = TextDrawCreate(23.411453, 432.666900, "100");
	...
	TextDrawBoxColor(LogoTD[0], -56286977);
	...
	LogoTD[1] = TextDrawCreate(64.172798, 433.250122, "100");
	TextDrawLetterSize(LogoTD[1], -0.000468, 0.935136);
	...
	TextDrawBoxColor(LogoTD[1], -56286977);
	...
	TextDrawLetterSize(LogoTD[2], 0.000000, -0.260614);
	...
	TextDrawBoxColor(LogoTD[2], -56286977);
	...
	LogoTD[4] = TextDrawCreate(254.392379, 425.666717, "2021.2022");
	...
	LogoTD[5] = TextDrawCreate(393.543304, 425.083465, "1602");
    ...
    kontenTD[playerid][0] = CreatePlayerTextDraw(playerid, 478.000000, 12.000000, "VG Community");
	PlayerTextDrawFont(playerid, kontenTD[playerid][0], 2);
	PlayerTextDrawLetterSize(playerid, kontenTD[playerid][0], 0.460000, 1.099999);
//	PlayerTextDrawTextSize(playerid, kontenTD[playerid][0], 116.000000, 0.000000);
	PlayerTextDrawSetOutline(playerid, kontenTD[playerid][0], 1);
	PlayerTextDrawSetShadow(playerid, kontenTD[playerid][0], 0);
	PlayerTextDrawAlignment(playerid, kontenTD[playerid][0], 1);
	PlayerTextDrawColor(playerid, kontenTD[playerid][0], -2013265665);
	PlayerTextDrawBackgroundColor(playerid, kontenTD[playerid][0], 16777215);
//	PlayerTextDrawBoxColor(playerid, kontenTD[playerid][0], -16776961);
//	PlayerTextDrawUseBox(playerid, kontenTD[playerid][0], 1);
	PlayerTextDrawSetProportional(playerid, kontenTD[playerid][0], 1);
	PlayerTextDrawSetSelectable(playerid, kontenTD[playerid][0], 0);

	kontenTD[playerid][1] = CreatePlayerTextDraw(playerid, 5.000000, 152.000000, "Cap Do");
	PlayerTextDrawFont(playerid, kontenTD[playerid][1], 1);
	PlayerTextDrawLetterSize(playerid, kontenTD[playerid][1], 0.400000, 1.200000);
//	PlayerTextDrawTextSize(playerid, kontenTD[playerid][7], 400.000000, 17.000000);
	...
	PlayerTextDrawSetShadow(playerid, kontenTD[playerid][1], 1);
	PlayerTextDrawAlignment(playerid, kontenTD[playerid][1], 1);
	PlayerTextDrawColor(playerid, kontenTD[playerid][1], -1);
	PlayerTextDrawBackgroundColor(playerid, kontenTD[playerid][1], 255);
...
//	PlayerTextDrawSetSelectable(playerid, kontenTD[playerid][7], 0);
	...
	kontenTD[playerid][3] = CreatePlayerTextDraw(playerid, 3.000000, 172.000000, "Next Pay Check");
	PlayerTextDrawFont(playerid, kontenTD[playerid][2], 1);
	PlayerTextDrawLetterSize(playerid, kontenTD[playerid][2], 0.450000, 1.400000);
//	PlayerTextDrawTextSize(playerid, kontenTD[playerid][2], 116.000000, 0.000000);
	PlayerTextDrawSetOutline(playerid, kontenTD[playerid][2], 1);
	PlayerTextDrawSetShadow(playerid, kontenTD[playerid][2], 0);
	PlayerTextDrawAlignment(playerid, kontenTD[playerid][2], 1);
//	PlayerTextDrawColor(playerid, kontenTD[playerid][2], 16711935);
...
//	PlayerTextDrawUseBox(playerid, kontenTD[playerid][2], 1);
	...
	kontenTD[playerid][2] = CreatePlayerTextDraw(playerid, 4.000000, 210.000000, "Tien Ban");
	PlayerTextDrawFont(playerid, kontenTD[playerid][3], 2);
	PlayerTextDrawLetterSize(playerid, kontenTD[playerid][3], 0.370000, 1.200000);
//	PlayerTextDrawTextSize(playerid, kontenTD[playerid][3], 298.500000, 24.500000);
	...
	PlayerTextDrawSetShadow(playerid, kontenTD[playerid][3], 1);
	PlayerTextDrawAlignment(playerid, kontenTD[playerid][3], 1);
//	PlayerTextDrawColor(playerid, kontenTD[playerid][3], 16711935);
...
//	PlayerTextDrawUseBox(playerid, kontenTD[playerid][3], 1);
	...
	kontenTD[playerid][4] = CreatePlayerTextDraw(playerid, 50.000000, 152.000000, "1000");
	PlayerTextDrawFont(playerid, kontenTD[playerid][4], 2);
	PlayerTextDrawLetterSize(playerid, kontenTD[playerid][4], 0.450000, 1.400000);
//	PlayerTextDrawTextSize(playerid, kontenTD[playerid][2], 116.000000, 0.000000);
	PlayerTextDrawSetOutline(playerid, kontenTD[playerid][4], 1);
	PlayerTextDrawSetShadow(playerid, kontenTD[playerid][4], 0);
	PlayerTextDrawAlignment(playerid, kontenTD[playerid][4], 1);
	PlayerTextDrawColor(playerid, kontenTD[playerid][4], 16711935);
...
//	PlayerTextDrawUseBox(playerid, kontenTD[playerid][2], 1);
	...
	kontenTD[playerid][5] = CreatePlayerTextDraw(playerid, 67.089355, 209.000000, "1000000");
	PlayerTextDrawFont(playerid, kontenTD[playerid][5], 2);
	PlayerTextDrawLetterSize(playerid, kontenTD[playerid][5], 0.400000, 1.600000);
//	PlayerTextDrawTextSize(playerid, kontenTD[playerid][3], 298.500000, 24.500000);
	PlayerTextDrawSetOutline(playerid, kontenTD[playerid][5], 1);
	PlayerTextDrawSetShadow(playerid, kontenTD[playerid][5], 1);
	PlayerTextDrawAlignment(playerid, kontenTD[playerid][5], 1);
	PlayerTextDrawColor(playerid, kontenTD[playerid][5], 16711935);
...
//	PlayerTextDrawUseBox(playerid, kontenTD[playerid][3], 1);
	...
	kontenTD[playerid][6] = CreatePlayerTextDraw(playerid, 137.000000, 172.183441, "1000000");
	PlayerTextDrawFont(playerid, kontenTD[playerid][6], 2);
	PlayerTextDrawLetterSize(playerid, kontenTD[playerid][6], 0.400000, 1.600000);
//	PlayerTextDrawTextSize(playerid, kontenTD[playerid][3], 298.500000, 24.500000);
	PlayerTextDrawSetOutline(playerid, kontenTD[playerid][6], 1);
	PlayerTextDrawSetShadow(playerid, kontenTD[playerid][6], 1);
	PlayerTextDrawAlignment(playerid, kontenTD[playerid][6], 1);
	PlayerTextDrawColor(playerid, kontenTD[playerid][6], 16711935);
...
//	PlayerTextDrawUseBox(playerid, kontenTD[playerid][3], 1);
	...
	SendClientMessage( playerid, COLOR_WHITE, "SERVER: {ba55d3}Chao mung ban den voi Server VG-Community" );
...
public OnPlayerDisconnect(playerid, reason)
{
	...
	foreach(new i: Player) {
		if(Spectating[i] > 0 && Spectate[i] == playerid) {
			...
			SendClientMessageEx(i, COLOR_WHITE, "{7cfc00}Nguoi choi ban dang theo doi da thoat khoi may chu.");
		}
		if(GetPVarType(i, "_dCheck") && GetPVarInt(i, "_dCheck") == playerid) {
			DeletePVar(i, "_dCheck");
			SendClientMessageEx(i, COLOR_WHITE, "{7cfc00}Nguoi choi ban dang kiem tra da thoat khoi may chu.");
		}	
	}		
...
/*PlayerTextDrawShow(playerid, PlayerTD[playerid][0]);
		...
		PlayerTextDrawShow(playerid, HungerHUD[playerid]);
		PlayerTextDrawShow(playerid, HausHUD[playerid]);
		PlayerTextDrawShow(playerid, NguyuhHUD[playerid]);
		PlayerTextDrawShow(playerid, DarahVeh[playerid]);
...
public OnPlayerEnterCheckpoint(playerid)
{
    ...
    if(CP[playerid] == 1)
    {
    	...
    	ShowPlayerDialog(playerid, DADENNOINHANVIECLAM, DIALOG_STYLE_MSGBOX, "RADAR", "Ban da den vi tri ban tim!", "OK", "");
        DisablePlayerCheckpoint(playerid);
    }
    if(CP[playerid] == 2)
    {
        CP[playerid] = 0;
        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
    	ShowPlayerDialog(playerid, DADENNOINHANVIECLAM, DIALOG_STYLE_MSGBOX, "Tim viec lam", "Hay vao ben trong de nhan viec nhe.", "OK", "");
        DisablePlayerCheckpoint(playerid);
    }
	...
	{
		CP[playerid] = 0;
    /*    switch(random(2)) // random khai thac
								{
									case 0: // Cu 
									{
									    new string[128];
										SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban nhan duoc Cu.");
							            format(string, sizeof(string), "Ban nhan duoc mot Cu [%s]", PlayerInfo[playerid][pCu]);
										PlayerInfo[playerid][pCu] += 1;
									}
									case 1: // Fe
									{
									    new string[128];
										SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban nhan duoc Fe.");
										format(string, sizeof(string), "Ban nhan duoc Fe [%d/]", PlayerInfo[playerid][pFe]);
										PlayerInfo[playerid][pFe] += 1;
									}	
								}*/
    	GivePlayerCash(playerid, 4000);
    	SendClientMessage(playerid, COLOR_WHITE, "Ban da nhan duoc 4000$ cho cong viec cua minh");
        RemovePlayerAttachedObject(playerid, 1);
		ApplyAnimation(playerid, "CARRY", "putdwn05", 3.0, 0, 1, 1, 0, 0, 1);
		DisablePlayerCheckpoint(playerid);
    ...
    if(CP[playerid] == 4)
	{
		CP[playerid] = 0;
  		...
  		SendClientMessage(playerid, COLOR_WHITE, "Ban da nhan duoc 2000$ va 2 crack cho cong viec cua minh");
        RemovePlayerAttachedObject(playerid, 1);
		ApplyAnimation(playerid, "CARRY", "putdwn05", 3.0, 0, 1, 1, 0, 0, 1);
		DisablePlayerCheckpoint(playerid);
		SetPlayerSpecialAction(playerid, 0);
    ...
    if(CP[playerid] == 7)
	{
    	...
    	GivePlayerCash(playerid, 3500);
  		SendClientMessage(playerid, COLOR_WHITE, "Ban da nhan duoc 3500$ cho cong viec cua minh");
		DisablePlayerCheckpoint(playerid);
	...
	for(new h = 0; h < MAX_POINTS; h++)
	{
		if(Points[h][Type] == 3 && GetPVarInt(playerid, "CrateDeliver") == 1 && IsPlayerInRangeOfPoint(playerid, 6.0, 2166.3772,-1675.3829,15.0859))
		{
			...
			new level = PlayerInfo[playerid][pSmugSkill];
   			if(level >= 0 && level <= 20)
			{
			    SendClientMessageEx(playerid, COLOR_LIGHTBLUE,"* ban nhan duoc $125 cho viec cung cap Drug Crates.");
				GivePlayerCash(playerid, 125);
			}
			else if(level >= 21 && level <= 50)
			{
			    SendClientMessageEx(playerid, COLOR_LIGHTBLUE,"* ban nhan duoc $150 cho viec cung cap Drug Crates.");
				GivePlayerCash(playerid, 150);
			}
			else if(level >= 51 && level <= 100)
			{
			    SendClientMessageEx(playerid, COLOR_LIGHTBLUE,"* ban nhan duoc $200 cho viec cung cap Drug Crates.");
				GivePlayerCash(playerid, 200);
			}
			else if(level >= 101 && level <= 200)
			{
			    SendClientMessageEx(playerid, COLOR_LIGHTBLUE,"* ban nhan duoc $300 cho viec cung cap Drug Crates.");
				GivePlayerCash(playerid, 300);
			}
			else if(level >= 201)
			{
			    SendClientMessageEx(playerid, COLOR_LIGHTBLUE,"* ban nhan duoc $400 cho viec cung cap Drug Crates.");
	...
	if(GetPVarInt(playerid, "TruckDeliver") > 0 && gPlayerCheckpointStatus[playerid] != CHECKPOINT_RETURNTRUCK)
	{
		...
		if(!IsABoat(vehicleid))
		{
			...
			GameTextForPlayer(playerid, "~w~Dia diem ~r~tra hang", 5000, 1);
	...
	if(GetPVarInt(playerid, "Pizza") > 0 && IsPlayerInRangeOfPoint(playerid, 5.0, HouseInfo[GetPVarInt(playerid, "Pizza")][hExteriorX], HouseInfo[GetPVarInt(playerid, "Pizza")][hExteriorY], HouseInfo[GetPVarInt(playerid, "Pizza")][hExteriorZ]) && GetPlayerInterior(playerid) == HouseInfo[GetPVarInt(playerid, "Pizza")][hExtIW] && GetPlayerVirtualWorld(playerid) == HouseInfo[GetPVarInt(playerid, "Pizza")][hExtVW])
	{
		...
		format(string, sizeof(string), "Ban da van chuyen banh pizza toi dich! Ban nhan duoc $%d tien banh.", (GetPVarInt(playerid, "pizzaTimer") * 6));
		Misc_Save();
		GivePlayerCash(playerid, floatround((GetPVarInt(playerid, "pizzaTimer") * 1000), floatround_round));
		SendClientMessageEx(playerid, COLOR_WHITE, string);
	...
	else
	{
		...
		{
			case CHECKPOINT_NGUDAN:
			{
				new vehicleid = GetPlayerVehicleID(playerid);
	   			if(IsAThuyenNguDan(vehicleid) && GetPlayerState(playerid) == PLAYER_STATE_DRIVER)
		    	{
					TogglePlayerControllable(playerid, 0);
					SetTimerEx("ThoiGianThaLuoi", 10000, 0, "d", playerid);
					GameTextForPlayer(playerid, "~n~~n~~n~~n~~n~~n~~n~Dang Tha Luoi", 10000, 5);
					DisablePlayerCheckpoint(playerid);
					gPlayerCheckpointStatus[playerid] = CHECKPOINT_NONE;
				}
				else return SendClientMessageEx(playerid, COLOR_WHITE, "Ban khong o trong thuyen ngu dan!");
			}
			
			case CHECKPOINT_VESINH:
			{
				new vehicleid = GetPlayerVehicleID(playerid);
	   			if(IsAXeVeSinh(vehicleid) && GetPlayerState(playerid) == PLAYER_STATE_DRIVER)
		    	{
					CP[playerid] = 7;
					TogglePlayerControllable(playerid, 0);
					SetTimerEx("ThoiGianVeSinh", 10000, 0, "d", playerid);
					GameTextForPlayer(playerid, "~n~~n~~n~~n~~n~~n~~n~Dang Ve Sinh", 10000, 5);
					DisablePlayerCheckpoint(playerid);
					gPlayerCheckpointStatus[playerid] = CHECKPOINT_NONE;
				}
				else return SendClientMessageEx(playerid, COLOR_WHITE, "Ban khong o trong xe ve sinh!");
			}			
			...
			case CHECKPOINT_RETURNTRUCK:
			{
				...
				if(level >= 0 && level <= 50) payment = 45000;
				else if(level >= 51 && level <= 100) payment = 5750;
				else if(level >= 101 && level <= 200) payment = 8000;
				else if(level >= 201 && level <= 400) payment = 12500;
				else if(level >= 401) payment = 20000;
				...
				{
				    distancepay = floatmul(GetDistance(162.0734,-295.9796,1.5781, TruckerDropoffs[route][PosX], TruckerDropoffs[route][PosY], TruckerDropoffs[route][PosZ]), 1.5);
				}
				*/
				...
				if(TruckDeliveringTo[vehicleid] != INVALID_BUSINESS_ID) {
					//new iBusiness = TruckDeliveringTo[vehicleid];
				 	...
				 	//payment = floatround(iDist / 1 * payment);
					//if (payment > 60) payment = 60;
					...
					else if(truckdeliver >= 5 && truckdeliver <= 7)
					{
						...
						GivePlayerCash(playerid, payment);
		    			format(string, sizeof(string), "* Ban duoc tra $%d cho viec van chuyen hang hoa va tra lai xe.", payment);
		    			SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban nhan duoc 25 phan tram tien thuong do viec van chuyen hang hoa bat hop phap.");
					...
					if(truckdeliver == 5) // Weapons
					{
						...
						{
							if(level >= 0 && level <= 50) // truck level 1
							{
							...
							else if(level >= 51 && level <= 100) // truck level 2
							{
								switch(random(2)) // random katana va sdpistol
								{
									case 0: // katana
									{
							...
							{
								switch(random(3)) //  va sdpistol va shotgun
								{
									case 0: // 9mm
									{
										SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban nhan duoc mien phi 9mm cho viec van chuyen vu khi trai phep.");
							...
							{
								switch(random(2)) // random shotgun va rifle
								{
									case 0: // shotgun
									{
										SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban nhan duoc mien phi Shotgun cho viec van chuyen vu khi trai phep.");
									...
									case 1: // rifle
									{
										SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban nhan duoc mien phi Rifle cho viec van chuyen vu khi trai phep.");
										SendClientMessageEx(playerid, COLOR_YELLOW, "* Khong duoc su dung vu khi duoc thuong cho muc dich xau nhu KOS/DM nonRP, neu vi pham se bi han che vu khi.");
										GivePlayerValidWeapon(playerid, 33, 60000);
									}	
								}
							}
                            else if(level >= 101 && level <= 200) // truck level 5
                            {
                                switch(random(100)) // random 9mm va sdpistol
                                {
                                    case 0..44: // shotgun
                                    {
                                        SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban nhan duoc mien phi Shotgun cho viec van chuyen vu khi trai phep.");
					...
					if(truckdeliver == 6) // Drugs
					{
						...
						{
		                    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban da nhan duoc 1 pot & 1 cho viec van chuyen ma tuy bat hop phap.");
					    	PlayerInfo[playerid][pPot] += 1;
						...
						{
		                    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban da nhan duoc 2 pot & 2 cho viec van chuyen ma tuy bat hop phap.");
					  	  	PlayerInfo[playerid][pPot] += 2;
					    	PlayerInfo[playerid][pCrack] += 2;
						}
						else if(level >= 401)
						{
		                    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban da nhan duoc 3 pot & 3 cho viec van chuyen ma tuy bat hop phap.");
					...
					if(truckdeliver == 7) // Illegal materials
					{
						...
						{
		                    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban da nhan duoc 4000 cho viec van chuyen vat lieu bat hop phap.");
							PlayerInfo[playerid][pMats] += 4000;
						}
						else if(level >= 101 && level <= 200)
						{
		                    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban da nhan duoc 6000 cho viec van chuyen vat lieu bat hop phap.");
							PlayerInfo[playerid][pMats] += 6000;
						}
						else if(level >= 201 && level <= 500)
						{
		                    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban da nhan duoc 8000 cho viec van chuyen vat lieu bat hop phap.");
							PlayerInfo[playerid][pMats] += 8000;
						}
						else if(level >= 401)
						{
		                    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban da nhan duoc 10000 cho viec van chuyen vat lieu bat hop phap.");
...
public OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
	...
	if ((newkeys & KEY_YES))
    {
		...
		// Trucker
		GetActorPos(ActorTrucker, PosXACtor, PosYACtor, PosZACtor);
        if(IsPlayerInRangeOfPoint(playerid, 2.0, PosXACtor, PosYACtor, PosZACtor))
        {
            if(PlayerInfo[playerid][pJob] != 1 && PlayerInfo[playerid][pJob2] != 1)
            {
       			ShowPlayerDialog(playerid, ACTOR_XINVIEC, DIALOG_STYLE_LIST, "Cong Viec", "Xin viec\nNhan dong phuc", "Lua chon", "Huy bo");
				return 1;
			}
			else
			{
		...
		// Pizza
		GetActorPos(ActorPizza, PosXACtor, PosYACtor, PosZACtor);
        if(IsPlayerInRangeOfPoint(playerid, 2.0, PosXACtor, PosYACtor, PosZACtor))
        {
            if(PlayerInfo[playerid][pJob] != 2 && PlayerInfo[playerid][pJob2] != 2)
            {
		...
		// Khai thac
		GetActorPos(ActorKhaithac, PosXACtor, PosYACtor, PosZACtor);
        if(IsPlayerInRangeOfPoint(playerid, 2.0, PosXACtor, PosYACtor, PosZACtor))
        {
		...
		// Lam tac
		GetActorPos(ActorTieuphu, PosXACtor, PosYACtor, PosZACtor);
        if(IsPlayerInRangeOfPoint(playerid, 2.0, PosXACtor, PosYACtor, PosZACtor))
        {
		...
		// Ngu dan
		GetActorPos(ActorNguDan, PosXACtor, PosYACtor, PosZACtor);
        if(IsPlayerInRangeOfPoint(playerid, 2.0, PosXACtor, PosYACtor, PosZACtor))
        {
            if(PlayerInfo[playerid][pJob] != 5 && PlayerInfo[playerid][pJob2] != 5)
            {
		...
		// Nhan vien ve sinh
		GetActorPos(ActorNhanVienVeSinh, PosXACtor, PosYACtor, PosZACtor);
        if(IsPlayerInRangeOfPoint(playerid, 2.0, PosXACtor, PosYACtor, PosZACtor))
        {
            if(PlayerInfo[playerid][pJob] != 6 && PlayerInfo[playerid][pJob2] != 6)
            {
    ...
    if(newkeys & KEY_NO)
    {
        if(IsPlayerInAnyVehicle(playerid) && GetPlayerState(playerid) == PLAYER_STATE_DRIVER)
       {
            ...
            {
            new string[128];
            format(string, sizeof(string), "{FF8000}** {FFFF00}%s {00FFFF}dua chia khoa vao o va bat dong co xe.", GetPlayerNameEx(playerid));
            ProxDetector(30.0, playerid, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
...
public OnPlayerStateChange(playerid, newstate, oldstate)
{
	...
	if(newstate == PLAYER_STATE_DRIVER)
	{
		...
		if(GetCarBusiness(newcar) != INVALID_BUSINESS_ID && PlayerInfo[playerid][pAdmin] < 5)
        {
...
public OnPlayerCommandPerformed(playerid, cmdtext[], success)
{
 /*   new string[500];
    ...
    {
        new string[1280];
        format(string, sizeof(string), "Khong co lenh ~r~~h~%s~w~ trong he thong, vui long ~y~/trogiup~w~ de xem cac lenh co ban.", cmdtext);
	    HienTextDraw(playerid, string, 2000, 3);
        SetTimerEx("ClosedClientText", 2000, 0, "d", playerid);
    }
    return 1;
}
...
public OnPlayerCommandReceived(playerid, cmdtext[]) {
	...
	if(++CommandSpamTimes[playerid] >= 5 && PlayerInfo[playerid][pAdmin] < 5) {
		CommandSpamTimes[playerid] = 0;
...
public OnPlayerText(playerid, text[])
{
    if(!IsPlayerInAnyVehicle(playerid))
    {
        ...
        SetTimerEx("StopChat", 3000, 0, "d", playerid);
    }
	if(gPlayerLogged{playerid} != 1)
	{
		SendClientMessageEx(playerid, COLOR_RED, "Ban chua dang nhap.");
    ...
    if(gServerData[E_STARTED] && strval(text) == gServerData[E_ANSWER]) {
        ...
        format(msg,sizeof(msg),"%s da tra loi that chinh xac trong %i giay (Dap an: %i)",name, GetTimerInSeconds(GetTickCount(),gServerData[E_START_TIME]), gServerData[E_ANSWER]);
