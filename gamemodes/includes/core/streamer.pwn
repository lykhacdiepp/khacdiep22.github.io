...
{
    TruckerVehicles[0] = AddStaticVehicleEx(414,-1572.34008789,129.09317017,3.69948244,225.00000000,-1,-1,100); //Mule
	TruckerVehicles[1] = AddStaticVehicleEx(414,-1575.85583496,125.90543365,3.69948244,225.00000000,-1,-1,100); //Mule
	TruckerVehicles[2] = AddStaticVehicleEx(414,-1578.88806152,122.54198456,3.69948244,225.00000000,-1,-1,100); //Mule
	TruckerVehicles[3] = AddStaticVehicleEx(414,-1581.52319336,119.51720428,3.69948244,225.00000000,-1,-1,100); //Mule
	TruckerVehicles[4] = AddStaticVehicleEx(414,-1584.36132812,116.68750000,3.69948244,225.00000000,-1,-1,100); //Mule
	TruckerVehicles[5] = AddStaticVehicleEx(414,-1569.55114746,131.97119141,3.69948244,225.00000000,-1,-1,100); //Mule
	TruckerVehicles[6] = AddStaticVehicleEx(456,-1587.84814453,113.03244019,3.79948235,225.00000000,-1,-1,100); //Yankee
	TruckerVehicles[7] = AddStaticVehicleEx(456,-1591.30224609,109.38220215,3.79948235,225.00000000,-1,-1,100); //Yankee
	TruckerVehicles[8] = AddStaticVehicleEx(456,-1595.57812500,105.83326721,3.79948235,225.00000000,-1,-1,100); //Yankee
	TruckerVehicles[9] = AddStaticVehicleEx(456,-1599.55334473,102.00447845,3.79948235,225.00000000,-1,-1,100); //Yankee
	...
	XeRacVehicles[0] =  AddStaticVehicleEx(408,830.8029,-609.5292,16.8871,358.9131,-1,-1,0); //Trashmaster
	XeRacVehicles[1] =  AddStaticVehicleEx(408,820.2510,-609.9193,16.8805,0.8343,-1,-1,0); //Trashmaster
/*	XeRacVehicles[2] =  AddStaticVehicleEx(408,2155.3767,-1972.1223,14.0368,180.0446,-1,-1,0); //Trashmaster
	XeRacVehicles[3] =  AddStaticVehicleEx(408,2150.3767,-1972.1223,14.0368,180.0446,-1,-1,0); //Trashmaster
	XeRacVehicles[4] =  AddStaticVehicleEx(408,2145.3767,-1972.1223,14.0368,180.0446,-1,-1,0); //Trashmaster
	XeRacVehicles[5] =  AddStaticVehicleEx(408,2140.3767,-1972.1223,14.0368,180.0446,-1,-1,0); //Trashmaster
	XeRacVehicles[6] =  AddStaticVehicleEx(408,2135.3767,-1972.1223,14.0368,180.0446,-1,-1,0); //Trashmaster
	XeRacVehicles[7] =  AddStaticVehicleEx(408,2130.3767,-1972.1223,14.0368,180.0446,-1,-1,0); //Trashmaster
	XeRacVehicles[8] =  AddStaticVehicleEx(408,2125.3767,-1972.1223,14.0368,180.0446,-1,-1,0); //Trashmaster
	XeRacVehicles[9] =  AddStaticVehicleEx(408,2120.3767,-1972.1223,14.0368,180.0446,-1,-1,0); //Trashmaster
	*/

	NguDanVehicles[0] =  AddStaticVehicleEx(453,-43.0877, -1625.7786, -0.4654, 116.3039, 0, 0, 0, 0, 0, 0); //Reefer
	NguDanVehicles[1] =  AddStaticVehicleEx(453,-1614.0908, -0.5541, 308.6618, 0, 0, 0, 0, 0, 0); //Reefer
	NguDanVehicles[2] =  AddStaticVehicleEx(453,-38.1752, -1619.3611, -0.5947, 272.4581, 0, 0, 0, 0, 0, 0); //Reefer
	NguDanVehicles[3] =  AddStaticVehicleEx(453,126.3278, -1837.6306, 0.6326, 90.7200, -1, -1, 100); //Reefer
...
public LoadStreamerDynamicPickups()
{
	...
	*/
	...
	CreateDynamicPickup(1239, 23, 1141.0751,-1410.9397,13.6576);// NGGShop - Hotdog Stand
	...
	CreateDynamicPickup(1239, 23, 809.5466,-600.5292,16.3359); //Don ve sinh
	CreateDynamicPickup(1239, 23, 2050.4036,-66.2830,-0.2110); //Tha luoi
...
public LoadStreamerDynamic3DTextLabels()
{
	...
	CreateDynamic3DTextLabel("Vi tri bat dau lam viec\n/vesinh de bat dau",COLOR_YELLOW,809.5466,-600.5292,16.3359+0.6,25.0);
	CreateDynamic3DTextLabel("Vi tri bat dau lam viec\n/thaluoi",COLOR_YELLOW,-34.45,-1626.81,-0.44+0.6,50.0);
    ...
    CreateDynamic3DTextLabel("Su Dung /laybanh de nhan banh \nDe co Pizza giao hang!",COLOR_YELLOW,1714.26,1343.74,7.18, 4.0); // Lay banh (LS)
    CreateDynamicPickup(1239, 23, -1713.961425, 1348.545166, 7.180452, -1); // pizza boy
...
/*    CreateDynamic3DTextLabel("/muadochoi\n De mua phu kien trang tri.",COLOR_YELLOW,206.3253,-100.3268,1005.2578,8.0);
	...
	*/
	...
	CreateDynamic3DTextLabel("NPC Drugs Dealer\nan Y de tuong tac voi NPC",COLOR_YELLOW,-2174.87,-265.53,36.51+0.5,4.0);//Drugs Dealer
//	CreateDynamic3DTextLabel("NPC Arms Dealer\nan Y de tuong tac voi NPC",COLOR_YELLOW,2120.6250,-2000.2983,7.9844+0.5,4.0);//Arms Dealer
	...
	CreateDynamic3DTextLabel("Vi tri rua tien\n/ruatien de tien hanh rua tien",COLOR_YELLOW,-1618.99,867.93,7.69+0.5,4.0);//Rua tien 1
	CreateDynamic3DTextLabel("Vi tri san xuat can sa\n/sanxuat de tien hanh san xuat",COLOR_YELLOW,-2454.92,-135.82,26.17+0.5,4.0);//Rua tien 1
//	CreateDynamic3DTextLabel("Vi tri rua tien 2\n/ruatien de tien hanh rua tien",COLOR_YELLOW,2676.6377,-1539.2467,25.7824+0.5,4.0);//Rua tien 2
	...
	CreateDynamic3DTextLabel("NPC CHO DEN\nan Y de tuong tac voi NPC",COLOR_YELLOW,864.3323,-16.9106,63.1953+0.5,4.0);//Buon can sa
	CreateDynamic3DTextLabel("NPC Buon ma tuy\nan Y de tuong tac voi NPC",COLOR_YELLOW,1566.9152,17.7633,24.1641+0.5,4.0);//Buon ma tuy
	CreateDynamic3DTextLabel("can sa o day /thuhoach cansa!!!",COLOR_YELLOW,-2780.23,-30.39,7.182+0.5,5.0);//Buon ma tuy

	// Actor Xin viec
	CreateDynamic3DTextLabel("{28ed00}Cong viec Trucker \n{fffafa}((an {ffe100}Y {fffafa}de tuong tac voi NPC))",COLOR_YELLOW,-1560.963867,127.491157,3.554687+0.5,4.0);// Trucker (LS)
	CreateDynamic3DTextLabel("{28ed00}Cong viec Pizza \n {fffafa}((an {ffe100}Y {fffafa}de tuong tac voi NPC))",COLOR_YELLOW,-1718.90,1355.63,7.18+0.5,4.0);// Pizza (LS)
	CreateDynamic3DTextLabel("{28ed00}Cong viec Khai thac \n{fffafa}((an {ffe100}Y {fffafa}de tuong tac voi NPC))",COLOR_YELLOW,-729.19,1532.09,40.05+0.5,4.0);// Khai Thac (LS)
	CreateDynamic3DTextLabel("{28ed00}Cong viec Lam tac \n{fffafa}((an {ffe100}Y {fffafa}de tuong tac voi NPC))",COLOR_YELLOW,-0.09,969.42,19.75+0.5,4.0);// Lam Tac (LS)
	CreateDynamic3DTextLabel("{28ed00}Cong viec Ngu dan \n{fffafa}((an {ffe100}Y {fffafa}de tuong tac voi NPC))",COLOR_YELLOW,-53.4510, -1608.4147, 3.103+0.5,4.0);// Ngu dan (LS)
	CreateDynamic3DTextLabel("{28ed00}Cong viec Nhan vien ve sinh \n{fffafa}((an {ffe100}Y {fffafa}de tuong tac voi NPC))",COLOR_YELLOW,810.6426,-613.7755,16.3359+0.5,4.0);// Nhan vien ve sinh (LS)

	CreateDynamic3DTextLabel("Dia diem khai thac\n[/khaithac]",COLOR_YELLOW,-720.88,1546.81,40.48+0.5,4.0);// Khai thac 1 (LS)
	CreateDynamicPickup(1239, 23, -720.88,1546.81,40.48, -1);


	CreateDynamic3DTextLabel("Dia diem lay go\n[/cuacay]",COLOR_YELLOW,-1.45,997.44,19.55+0.5,4.0);// Khai thac 1 (LS)
	...
	CreateDynamic3DTextLabel("Hot Dogs\n/muahotdog", COLOR_YELLOW, 1141.0751,-1410.9397,13.6576+0.6, 10.0);
...
public LoadStreamerDynamicObjects()
{
	...
	CreateDynamicObject(3050, 2121.78, -2014.36, 9.21,   0.00, 0.00, 40.44);
	CreateDynamicObject(3050, 2125.94, -2010.91, 9.21,   0.00, 0.00, -10.86);
	CreateDynamicObject(3050, 2129.49, -2007.91, 9.21,   0.00, 0.00, 40.44);
	CreateDynamicObject(2047, 2127.67, -2009.52, 9.73,   0.00, 0.00, 40.26);
	CreateDynamicObject(2047, 2120.03, -2015.87, 9.71,   0.00, 0.00, 40.26);
	CreateDynamicObject(1440, 2127.62, -2010.77, 7.48,   0.00, 0.00, 36.18);
	CreateDynamicObject(1440, 2130.23, -2008.64, 7.48,   0.00, 0.00, 36.18);
	CreateDynamicObject(1438, 2129.67, -2010.90, 6.98,   0.00, 0.00, -122.70);
	CreateDynamicObject(1438, 2121.04, -2016.60, 6.98,   0.00, 0.00, 48.66);
	CreateDynamicObject(1440, 2121.60, -2018.21, 7.48,   0.00, 0.00, 145.98);
	CreateDynamicObject(910, 2131.82, -2011.86, 8.19,   0.00, 0.00, -4.62);
	CreateDynamicObject(3861, 2114.66, -2011.63, 8.05,   0.00, 0.00, 136.80);
	CreateDynamicObject(3040, 2124.77, -2006.02, 9.23,   0.00, 0.00, 44.52);
	CreateDynamicObject(3862, 2120.33, -2000.53, 8.09,   0.00, 0.00, -45.60);
	CreateDynamicObject(3863, 2110.31, -2006.72, 8.12,   0.00, 0.00, 114.06);
	CreateDynamicObject(3039, 2116.01, -2005.33, 6.86,   0.00, 0.00, -46.68);
	CreateDynamicObject(2619, 2120.66, -1999.10, 8.35,   -18.96, -0.06, 44.28);
	CreateDynamicObject(2619, 2121.61, -2000.05, 8.35,   2.16, 1.02, 44.28);
	CreateDynamicObject(3016, 2120.82, -2001.65, 7.86,   0.00, 0.00, 0.00);
	CreateDynamicObject(1650, 2120.71, -2002.05, 8.02,   0.00, 0.00, -115.02);
	CreateDynamicObject(1650, 2120.41, -2001.97, 8.02,   0.00, 0.00, -153.66);
	CreateDynamicObject(2358, 2119.35, -1999.96, 7.83,   0.00, 0.00, -26.64);
	CreateDynamicObject(2359, 2119.04, -2000.44, 7.92,   0.00, 0.00, -37.50);
	CreateDynamicObject(2042, 2119.40, -1999.95, 8.03,   0.00, 0.00, -29.94);
	CreateDynamicObject(2041, 2119.76, -2000.37, 7.91,   0.00, 0.00, 0.00);
	CreateDynamicObject(2040, 2118.84, -2000.35, 7.80,   0.00, 0.00, 52.92);
	CreateDynamicObject(2038, 2119.76, -2000.61, 7.80,   0.00, 0.00, 0.00);
	CreateDynamicObject(2037, 2119.56, -2000.78, 7.78,   0.00, 0.00, 13.50);
	CreateDynamicObject(2037, 2119.76, -2000.77, 7.78,   0.00, 0.00, -39.48);
	CreateDynamicObject(3014, 2119.27, -2000.06, 7.19,   0.00, 0.00, 41.40);
	CreateDynamicObject(3014, 2118.83, -2000.49, 7.19,   0.00, 0.00, 41.40);
	CreateDynamicObject(1271, 2119.65, -2000.79, 7.31,   0.00, 0.00, 41.88);
	CreateDynamicObject(1271, 2120.18, -2001.39, 7.31,   0.00, 0.00, 41.88);
	CreateDynamicObject(2358, 2120.54, -2002.04, 7.08,   0.00, 0.00, 45.18);
	CreateDynamicObject(2358, 2120.54, -2002.04, 7.30,   0.00, 0.00, 45.18);
	CreateDynamicObject(2358, 2121.06, -2001.46, 7.10,   0.00, 0.00, 78.36);
	CreateDynamicObject(2358, 2121.06, -2001.46, 7.32,   0.00, 0.00, 78.36);
	CreateDynamicObject(2358, 2121.81, -2001.08, 7.10,   0.00, 0.00, 219.42);
	CreateDynamicObject(2358, 2121.81, -2001.08, 7.32,   0.00, 0.00, 219.42);
	CreateDynamicObject(2359, 2121.40, -2000.66, 7.19,   0.00, 0.00, -147.48);
	CreateDynamicObject(335, 2120.35, -2001.87, 7.70,   90.78, 26.40, 70.44);
	CreateDynamicObject(335, 2120.51, -2001.71, 7.70,   90.78, 26.40, 110.52);
	CreateDynamicObject(335, 2120.39, -2001.40, 7.70,   90.78, 26.40, 238.74);
	CreateDynamicObject(3028, 2119.93, -2001.91, 7.72,   98.16, 46.74, 0.00);
	CreateDynamicObject(3028, 2119.98, -2001.65, 7.72,   98.16, 46.74, 11.82);
	CreateDynamicObject(1458, 2127.53, -2007.48, 7.19,   0.00, 0.00, 121.80);
	CreateDynamicObject(2969, 2124.13, -2003.47, 7.09,   0.00, 0.00, 0.00);
	CreateDynamicObject(2969, 2124.13, -2003.47, 7.31,   0.00, 0.00, 0.00);
	CreateDynamicObject(2969, 2124.13, -2003.47, 7.50,   0.00, 0.00, 0.00);
	CreateDynamicObject(2969, 2123.74, -2002.88, 7.10,   0.00, 0.00, 46.56);
	CreateDynamicObject(2969, 2123.74, -2002.88, 7.31,   0.00, 0.00, 46.56);
	CreateDynamicObject(2969, 2124.69, -2003.85, 7.07,   0.00, 0.00, 63.36);
	CreateDynamicObject(1575, 2114.18, -2010.61, 7.65,   0.00, 0.00, 0.00);
	CreateDynamicObject(1575, 2114.34, -2010.15, 7.65,   0.00, 0.00, 36.18);
	CreateDynamicObject(1575, 2114.52, -2010.56, 7.69,   -0.30, 15.72, 21.78);
	CreateDynamicObject(1575, 2114.34, -2010.15, 7.77,   0.00, 0.00, 49.20);
	CreateDynamicObject(1577, 2116.04, -2011.63, 7.65,   0.00, 0.00, 0.00);
	CreateDynamicObject(1577, 2115.86, -2012.07, 7.65,   0.00, 0.00, -86.04);
	CreateDynamicObject(1579, 2115.40, -2011.74, 7.64,   0.00, 0.00, -65.70);
	CreateDynamicObject(1579, 2115.40, -2011.74, 7.74,   0.00, 0.00, -65.70);
	CreateDynamicObject(2969, 2115.28, -2011.13, 7.08,   0.00, 0.00, 0.00);
	CreateDynamicObject(2969, 2114.60, -2010.53, 7.08,   0.00, 0.00, 70.74);
	CreateDynamicObject(1271, 2115.44, -2013.98, 7.29,   0.00, 0.00, -44.94);
	CreateDynamicObject(1271, 2115.44, -2013.98, 7.95,   0.00, 0.00, -44.94);
	CreateDynamicObject(1271, 2116.64, -2014.27, 7.31,   0.00, 0.00, -7.02);
	CreateDynamicObject(1271, 2116.64, -2014.27, 7.99,   0.00, 0.00, -7.02);
	CreateDynamicObject(1271, 2117.49, -2014.56, 7.31,   0.00, 0.00, 15.42);
	CreateDynamicObject(1271, 2111.46, -2009.88, 7.30,   0.00, 0.00, -38.40);
	CreateDynamicObject(1271, 2110.90, -2009.23, 7.30,   0.00, 0.00, -53.52);
	CreateDynamicObject(1271, 2111.46, -2009.88, 7.96,   0.00, 0.00, -38.40);
	CreateDynamicObject(18633, 2111.74, -2007.44, 7.77,   0.00, 0.00, 0.00);
	CreateDynamicObject(18633, 2111.56, -2007.36, 7.77,   0.00, 0.00, -31.32);
	CreateDynamicObject(18633, 2111.49, -2007.37, 7.77,   0.00, 0.00, -32.82);
	CreateDynamicObject(18633, 2110.99, -2005.38, 7.77,   -1.20, 95.64, 26.94);
	CreateDynamicObject(18633, 2110.78, -2005.37, 7.77,   -1.20, 95.64, -167.82);
	CreateDynamicObject(18634, 2110.19, -2005.74, 7.77,   0.78, -89.88, 0.00);
	CreateDynamicObject(18634, 2110.44, -2005.78, 7.77,   -0.30, -96.12, -132.42);
	CreateDynamicObject(18634, 2110.53, -2005.64, 7.78,   -1.32, -93.60, -114.00);
	CreateDynamicObject(18635, 2110.82, -2006.60, 7.81,   -88.80, -76.86, 0.00);
	CreateDynamicObject(18635, 2110.89, -2006.73, 7.81,   -88.80, -76.86, 66.84);
	CreateDynamicObject(18635, 2111.22, -2006.71, 7.81,   -88.80, -76.86, 45.24);
	CreateDynamicObject(337, 2111.02, -2004.98, 7.33,   -1.02, -6.78, 28.50);
	CreateDynamicObject(337, 2111.15, -2005.28, 7.33,   -1.02, -6.78, 28.50);
	CreateDynamicObject(18451, 2114.04, -1997.56, 7.52,   0.00, 0.00, 37.92);
	CreateDynamicObject(3050, 2114.84, -1992.97, 9.14,   0.00, 0.00, 43.50);
	CreateDynamicObject(3050, 2111.45, -1996.13, 9.14,   0.00, 0.00, 43.50);
	CreateDynamicObject(3050, 2106.26, -2001.03, 9.14,   0.00, 0.00, 79.56);
	CreateDynamicObject(1335, 2108.46, -1997.74, 8.06,   0.00, 0.00, 135.12);
	CreateDynamicObject(1330, 2109.67, -1996.80, 7.42,   0.00, 0.00, 0.00);
	CreateDynamicObject(1330, 2110.33, -1996.15, 7.17,   -28.98, -97.26, 0.00);
	CreateDynamicObject(910, 2111.08, -1994.72, 8.19,   0.00, 0.00, -76.98);
	CreateDynamicObject(910, 2112.83, -1993.15, 8.19,   0.00, 0.00, -130.20);
	CreateDynamicObject(14791, 2107.01, -1989.31, 8.10,   0.00, 0.00, -45.18);
	CreateDynamicObject(14782, 2100.30, -1998.82, 7.92,   0.00, 0.00, 134.58);
	CreateDynamicObject(14779, 2100.63, -1994.56, 9.25,   0.00, 0.00, 45.90);
	CreateDynamicObject(14779, 2097.58, -1991.49, 9.25,   0.00, 0.00, 45.90);
	CreateDynamicObject(2047, 2108.97, -1987.29, 9.81,   0.00, 0.00, -43.92);
	CreateDynamicObject(1462, 2111.83, -1990.80, 6.99,   0.00, 0.00, -46.98);
	CreateDynamicObject(1810, 2102.66, -1989.92, 6.98,   0.00, 0.00, 87.36);
	CreateDynamicObject(1810, 2102.32, -1988.84, 6.98,   0.00, 0.00, 196.56);
	CreateDynamicObject(1810, 2105.63, -1993.82, 6.98,   0.00, 0.00, 138.12);
	CreateDynamicObject(1810, 2104.88, -1993.27, 6.98,   0.00, 0.00, 120.90);
	CreateDynamicObject(1810, 2104.26, -1993.16, 6.98,   2.40, 91.20, 120.90);
	CreateDynamicObject(1810, 2103.02, -1991.70, 6.98,   0.00, 0.00, 105.84);
	CreateDynamicObject(1439, 2097.21, -1995.59, 7.03,   0.00, 0.00, 134.16);
	CreateDynamicObject(1372, 2096.88, -1993.35, 7.07,   0.00, 0.00, 80.64);
	CreateDynamicObject(2916, 2099.23, -1996.65, 7.02,   0.00, 0.00, 0.00);
	CreateDynamicObject(2916, 2098.90, -1996.46, 7.02,   0.00, 0.00, 38.70);
	CreateDynamicObject(4227, 2092.68, -1991.67, 9.68,   0.00, 0.00, -225.30);
	CreateDynamicObject(17969, 2104.45, -1982.74, 9.04,   0.00, 0.00, 44.46);
	CreateDynamicObject(12846, 2113.32, -1995.42, 5.66,   0.00, 0.00, -45.96);
	CreateDynamicObject(7415, 2109.45, -2009.61, 4.80,   0.00, 0.00, -105.42);
	CreateDynamicObject(3260, 2091.40, -1989.35, 7.53,   0.30, -0.30, -104.22);
	CreateDynamicObject(3260, 2091.88, -1987.41, 7.53,   0.30, -0.30, -104.22);
	CreateDynamicObject(3260, 2091.36, -1985.80, 7.53,   0.30, -0.30, -41.88);
	CreateDynamicObject(3260, 2088.84, -1984.60, 7.53,   0.30, -0.30, 17.58);
	CreateDynamicObject(3260, 2087.13, -1985.54, 7.53,   0.30, -0.30, 39.42);
	CreateDynamicObject(3260, 2087.71, -1986.35, 9.54,   89.46, 9.96, 28.50);
	CreateDynamicObject(3260, 2089.15, -1985.20, 9.54,   89.46, 9.96, 40.44);
	CreateDynamicObject(3260, 2089.49, -1988.76, 9.56,   89.46, 9.96, 28.50);
	CreateDynamicObject(3260, 2090.52, -1987.50, 9.56,   89.46, 9.96, 29.64);
	CreateDynamicObject(3260, 2090.27, -1987.20, 9.56,   89.46, 9.96, 95.70);
	CreateDynamicObject(14861, 2090.25, -1987.96, 6.99,   0.00, 0.00, 49.44);
	CreateDynamicObject(911, 2088.44, -1986.57, 7.49,   0.00, 0.00, 134.94);
	CreateDynamicObject(1407, 2091.63, -1988.67, 7.42,   0.00, -41.94, 77.82);
	CreateDynamicObject(2843, 2090.79, -1987.76, 6.99,   0.00, 0.00, 0.00);
	CreateDynamicObject(2846, 2090.91, -1986.99, 6.98,   0.00, 0.00, 42.42);
	CreateDynamicObject(2068, 2087.36, -1990.01, 9.79,   -4.98, 7.74, -5.16);
	CreateDynamicObject(3260, 2103.29, -1982.78, 7.91,   0.00, 0.00, 39.12);
	CreateDynamicObject(3260, 2101.80, -1983.99, 7.91,   0.00, 0.00, 39.12);
	CreateDynamicObject(3260, 2100.31, -1984.08, 7.91,   0.00, 0.00, -35.82);
	CreateDynamicObject(3260, 2099.49, -1982.61, 7.91,   0.00, 0.00, 92.10);
	CreateDynamicObject(3260, 2101.03, -1980.05, 7.91,   0.00, 0.00, 42.00);
	CreateDynamicObject(3260, 2101.59, -1980.73, 9.92,   89.52, -10.50, 51.18);
	CreateDynamicObject(3260, 2102.09, -1981.19, 9.92,   89.52, -10.50, 51.18);
	CreateDynamicObject(3260, 2100.22, -1982.03, 9.92,   89.52, -10.50, 51.18);
	CreateDynamicObject(3260, 2100.61, -1982.46, 9.92,   89.52, -10.50, 51.18);
	CreateDynamicObject(3260, 2100.18, -1982.78, 9.92,   89.52, -10.50, 51.18);
	CreateDynamicObject(1460, 2100.20, -1984.13, 7.30,   -2.76, -84.84, -34.44);
	CreateDynamicObject(1460, 2102.95, -1983.08, 8.31,   -2.82, -27.42, 38.40);
	CreateDynamicObject(1462, 2099.81, -1984.34, 6.99,   0.00, 0.00, -39.96);
	CreateDynamicObject(14861, 2102.34, -1982.53, 6.99,   0.00, 0.00, -51.06);
	CreateDynamicObject(2846, 2100.89, -1980.79, 6.99,   0.00, 0.00, -27.96);
	CreateDynamicObject(2845, 2100.12, -1981.58, 6.98,   0.00, 0.00, -21.48);
	CreateDynamicObject(3050, 2086.59, -1985.76, 9.17,   0.00, 0.00, -135.72);
	CreateDynamicObject(3050, 2089.96, -1982.50, 9.17,   0.00, 0.00, -135.72);
	CreateDynamicObject(3050, 2093.28, -1979.26, 9.17,   0.00, 0.00, -135.72);
	CreateDynamicObject(3050, 2096.63, -1976.05, 9.17,   0.00, 0.00, -135.72);
	CreateDynamicObject(1372, 2097.27, -1976.95, 7.07,   0.00, 0.00, 0.00);
	CreateDynamicObject(1439, 2099.12, -1977.96, 7.00,   0.00, 0.00, 4-42.84);
	CreateDynamicObject(1271, 2095.80, -1978.03, 7.30,   0.00, 0.00, 0.00);
	CreateDynamicObject(1271, 2095.80, -1978.03, 7.97,   0.00, 0.00, 0.00);
	CreateDynamicObject(1271, 2094.88, -1978.46, 7.30,   0.00, 0.00, -31.20);
	CreateDynamicObject(1440, 2093.42, -1980.28, 7.45,   0.00, 0.00, 45.54);
	CreateDynamicObject(1438, 2091.56, -1982.54, 6.98,   0.00, 0.00, 45.18);
	CreateDynamicObject(1438, 2095.52, -1992.61, 6.95,   0.00, 0.00, 140.16);
	CreateDynamicObject(1438, 2093.14, -1989.99, 6.95,   0.00, 0.00, 119.70);
	CreateDynamicObject(913, 2094.24, -1990.99, 7.37,   -90.42, -11.76, -67.92);
	CreateDynamicObject(1358, 2103.17, -1985.15, 8.18,   0.00, 0.00, 43.98);
	CreateDynamicObject(2672, 2093.26, -1984.89, 7.28,   0.00, 0.00, 0.00);
	CreateDynamicObject(2672, 2100.50, -1987.83, 7.28,   0.00, 0.00, 109.68);
	CreateDynamicObject(2672, 2096.62, -1981.37, 7.28,   0.00, 0.00, 155.34);
	CreateDynamicObject(2672, 2096.66, -1991.16, 7.28,   0.00, 0.00, 9.84);
	CreateDynamicObject(2670, 2096.77, -1983.26, 7.08,   0.00, 0.00, 0.00);
	CreateDynamicObject(2670, 2096.74, -1985.17, 7.08,   0.00, 0.00, -55.98);
	CreateDynamicObject(2670, 2095.33, -1988.12, 7.08,   0.00, 0.00, -34.20);
	CreateDynamicObject(2673, 2097.74, -1988.55, 7.06,   0.00, 0.00, 0.00);
	
	// Job lam tac

	CreateDynamicObject(698, 2615.82056, -933.22272, 84.00000,   0.00000, 0.00000, 193.00000);
	CreateDynamicObject(698, 2642.65649, -924.75781, 80.50000,   0.00000, 0.00000, 55.00000);
	CreateDynamicObject(837, 2622.09741, -941.50079, 78.70000,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(836, 2619.50293, -936.24603, 79.50000,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(838, 2629.22217, -918.61945, 79.00000,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(1458, 2639.42432, -924.15411, 76.00000,   4.00000, 0.00000, 0.00000);
	CreateDynamicObject(1458, 2633.41870, -922.34412, 76.30000,   0.00000, 4.00000, 68.00000);
	CreateDynamicObject(1458, 2618.51929, -925.27362, 78.15000,   0.00000, 0.00000, -40.00000);
	CreateDynamicObject(1458, 2625.68799, -918.59149, 76.90000,   9.00000, 0.00000, -60.00000);
	CreateDynamicObject(1458, 2628.12744, -926.21393, 77.17000,   18.00000, 4.00000, 0.00000);
	CreateDynamicObject(836, 2627.26563, -922.00842, 77.90000,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(1458, 2607.56812, -939.24652, 79.00000,   18.00000, 0.00000, -113.00000);
	CreateDynamicObject(837, 2609.81323, -940.97998, 79.30000,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(18259, 2577.90332, -948.97229, 81.61000,   0.00000, 0.00000, 190.00000);
	CreateDynamicObject(1458, 2620.70068, -939.80792, 78.60000,   0.00000, 0.00000, -91.00000);
	CreateDynamicObject(836, 2638.07544, -926.15332, 77.00000,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(837, 2618.29761, -922.16913, 78.00000,   0.00000, 0.00000, 25.00000);
	CreateDynamicObject(837, 2634.53931, -922.11578, 76.00000,   0.00000, 11.00000, -316.00000);
	CreateDynamicObject(837, 2607.21997, -942.20587, 79.30000,   0.00000, 0.00000, 135.00000);
	CreateDynamicObject(837, 2636.86108, -926.20789, 76.56100,   0.00000, 0.00000, 142.00000);
	CreateDynamicObject(698, 2603.91553, -937.05121, 84.00000,   0.00000, 0.00000, 178.00000);
	CreateDynamicObject(837, 2606.48779, -943.93433, 79.60000,   0.00000, 0.00000, -113.00000);
	CreateDynamicObject(1458, 2604.74780, -943.58020, 79.70000,   0.00000, 0.00000, 0.00000);
	CreateDynamicObject(698, 2625.78589, -926.49463, 81.00000,   0.00000, 0.00000, 0.00000);	

	ActorDrugsDealer = 		CreateActor(294, -2174.87,-265.53,36.51,349.3108);
//	ActorArmsDealer = 		CreateActor(294, 2120.6250,-2000.2983,7.9844,133.6366);

	//Actor Buon can sa + ma tuy
	ActorPot = 				CreateActor(29, -2175.18,-265.18,36.51,62.0714);
	ActorCrack = 			CreateActor(29, -2454.92,-135.82,26.17,105.1637);
	//Cay ma tuy
	CreateDynamicObject(3409,-2780.23,-30.39,7.18,0.00000000,0.00000000,0.00000000,-1,10,-1,100.0);
	CreateDynamicObject(3409,1552.1687,-32.5040,21.3536,0.00000000,0.00000000,0.00000000,-1,10,-1,100.0);

	// Actor Xin viec
	ActorTrucker = 			CreateActor(153, -1560.963867,127.491157,3.554687,172.9628);
	ActorPizza = 			CreateActor(155, -1718.90,1355.63,7.18,95.9753);
	ActorKhaithac = 		CreateActor(27, -729.19,1532.09,40.05,266.8552);
	ActorTieuphu = 			CreateActor(16, -0.09,969.42,19.75,92.6851);
	ActorNguDan = 			CreateActor(97, 151.10,-1826.43,3.76);
	ActorNhanVienVeSinh = 	CreateActor(260, 810.6426,-613.7755,16.3359,359.2375);

	SetActorPos(ActorDrugsDealer, -2174.87,-265.53,36.51);
//    SetActorPos(ActorArmsDealer, 2120.6250,-2000.2983,7.9844);
    SetActorPos(ActorPot, 864.3323,-16.9106,63.1953);
    SetActorPos(ActorCrack, 1566.9152,17.7633,24.1641);
    SetActorPos(ActorTrucker, -1560.963867,127.491157,3.554687);
    SetActorPos(ActorPizza, -1718.90,1355.63,7.18);
    SetActorPos(ActorKhaithac, -729.19,1532.09,40.05);
    SetActorPos(ActorTieuphu, -0.09,969.42,19.75);
    
//ngudan
   CreateObject(6230, 143.22701, -1894.75305, -5.87600,   0.00000, 0.00000, 359.98901);
   CreateObject(6230, 135.71400, -1900.26294, -7.27600,   0.00000, 0.00000, 359.98901);
   CreateObject(6230, 143.22701, -1875.89795, -5.87600,   0.00000, 0.00000, 359.99451);
   CreateObject(6230, 135.71400, -1872.96594, -7.27600,   0.00000, 0.00000, 359.98901);
   CreateObject(6230, 143.64400, -1847.40295, -5.87600,   0.00000, 0.00000, 359.48901);
   CreateObject(6230, 136.08800, -1852.78101, -7.27600,   0.00000, 0.00000, 359.48901);
...
public RemoveBuildings(playerid)
{
    ...
    //làng
     RemoveBuildingForPlayer(playerid, 10936, -2103.6094, -462.1953, 37.3594, 0.25);
...
RemoveBuildingForPlayer(playerid, 731, -2058.8359, -368.1328, 33.9844, 0.25);
RemoveBuildingForPlayer(playerid, 731, -2167.3125, -363.5000, 33.9844, 0.25);
RemoveBuildingForPlayer(playerid, 708, -2185.6797, -433.3125, 34.3750, 0.25);
RemoveBuildingForPlayer(playerid, 731, -2010.2344, -555.4375, 31.8047, 0.25);
RemoveBuildingForPlayer(playerid, 731, -2133.7500, -491.2656, 36.5938, 0.25);
RemoveBuildingForPlayer(playerid, 708, -2043.9219, -551.1719, 34.6328, 0.25);
RemoveBuildingForPlayer(playerid, 708, -2066.3359, -543.2891, 34.6328, 0.25);
RemoveBuildingForPlayer(playerid, 11158, -2103.6094, -462.1953, 37.3594, 0.25);
RemoveBuildingForPlayer(playerid, 11209, -1942.8516, -361.2578, 33.4141, 0.25);
...
RemoveBuildingForPlayer(playerid, 1278, -2207.7813, -409.1797, 48.4766, 0.25);
...
RemoveBuildingForPlayer(playerid, 1278, -2169.4766, -447.5781, 48.4766, 0.25);
...
RemoveBuildingForPlayer(playerid, 1260, -2143.4609, -370.7500, 46.5469, 0.25);
...
RemoveBuildingForPlayer(playerid, 1411, -2107.6406, -374.4375, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2102.3750, -374.4375, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2097.1094, -374.4375, 35.6797, 0.25);
...
RemoveBuildingForPlayer(playerid, 1411, -2091.8516, -374.4375, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2086.5859, -374.4375, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2081.3281, -374.4375, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2076.0625, -374.4375, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2070.7969, -374.4375, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 955, -2068.5625, -398.3359, 34.7266, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2065.5547, -374.4375, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2060.3125, -374.4375, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2055.1016, -375.0156, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2049.9922, -376.1953, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2044.8828, -377.3750, 35.6797, 0.25);
RemoveBuildingForPlayer(playerid, 1411, -2039.7734, -378.5625, 35.6797, 0.25);
...
RemoveBuildingForPlayer(playerid, 955, -2011.1406, -398.3359, 34.7266, 0.25);
   ...
   RemoveBuildingForPlayer(playerid, 9963, -1459.1016, 920.0938, 31.9531, 0.25);
	...
	RemoveBuildingForPlayer(playerid, 617, 2620.9688, -966.2422, 78.8828, 0.25);
	RemoveBuildingForPlayer(playerid, 1407, 2574.4297, -951.4375, 81.0938, 0.25);
	RemoveBuildingForPlayer(playerid, 3241, 2581.5000, -949.9453, 80.7969, 0.25);
	RemoveBuildingForPlayer(playerid, 1407, 2573.2344, -946.8750, 81.0938, 0.25);
	RemoveBuildingForPlayer(playerid, 1407, 2597.7734, -949.3516, 80.7422, 0.25);
	RemoveBuildingForPlayer(playerid, 617, 2643.6953, -948.7109, 77.4219, 0.25);
	RemoveBuildingForPlayer(playerid, 617, 2605.3438, -946.5391, 79.1328, 0.25);
	RemoveBuildingForPlayer(playerid, 1410, 2574.9141, -943.9844, 81.0313, 0.25);
	RemoveBuildingForPlayer(playerid, 1410, 2584.0313, -941.8047, 81.0313, 0.25);
	RemoveBuildingForPlayer(playerid, 1407, 2579.5078, -942.8906, 81.0625, 0.25);
	RemoveBuildingForPlayer(playerid, 1407, 2596.7031, -944.7969, 80.6797, 0.25);
	RemoveBuildingForPlayer(playerid, 1407, 2595.6328, -940.2734, 80.7578, 0.25);
	RemoveBuildingForPlayer(playerid, 1407, 2588.3594, -940.1484, 81.0234, 0.25);
	RemoveBuildingForPlayer(playerid, 1410, 2592.7109, -938.5859, 80.9219, 0.25);	
