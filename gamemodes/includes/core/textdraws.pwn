...
{ 
    ...
    // Blindfold quyên add vào ðây b?o sao ko sc chí nh? nhu lozzzzzz
...
//a
	Logo[1] = TextDrawCreate(3.000000, 175.000000, "VIET NAM COUNTY");
	TextDrawBackgroundColor(Logo[1], 255);
	TextDrawFont(Logo[1], 2);
	TextDrawLetterSize(Logo[1], 0.209999, 1.000000);
	TextDrawColor(Logo[1], 16777215);
	TextDrawSetOutline(Logo[1], 1);
	TextDrawSetShadow(Logo[1], 5);
	textdrawscount++;
...
stock CreateHungerGamesTextdraw(playerid)
{
	...
	HungerPlayerInfo[playerid][hgCreditsText] = CreatePlayerTextDraw(playerid, 532.000000, 2.000000, "Battle Royal - VNC-RP");
...
stock CreatePlayerTextDraws(playerid)
{
	...
	_hungerText[playerid] = CreatePlayerTextDraw(playerid, 700.000000, 700.000000, "Trang Thai: ~w~Hai long");
