...
public OnQueryFinish(resultid, extraid, handleid)
{
	...
	switch(resultid)
	{
		...
		case LOADUSERDATA_THREAD:
		{
			if(IsPlayerConnected(extraid))
			{
				...
				for(new row;row < rows;row++)
				{
					...
					cache_get_field_content(row,  "TuiCanSa", szResult, MainPipeline); PlayerInfo[extraid][pTuicansa] = strval(szResult);
					cache_get_field_content(row,  "XacNhanDangKy", szResult, MainPipeline); PlayerInfo[extraid][pXacNhanDangKy] = strval(szResult);
					cache_get_field_content(row,  "TienBan", szResult, MainPipeline); PlayerInfo[extraid][pTienban] = strval(szResult);
					cache_get_field_content(row,  "CanCuoc", szResult, MainPipeline); PlayerInfo[extraid][pCancuoc] = strval(szResult);
					cache_get_field_content(row,  "Dau", szResult, MainPipeline); PlayerInfo[extraid][pDau] = strval(szResult);
					cache_get_field_content(row,  "GoiPot", szResult, MainPipeline); PlayerInfo[extraid][pGoiPot] = strval(szResult);
					cache_get_field_content(row,  "NhanQua", szResult, MainPipeline); PlayerInfo[extraid][pNhanQua] = strval(szResult);
					cache_get_field_content(row,  "PhieuThuong", szResult, MainPipeline); PlayerInfo[extraid][pPhieuThuong] = strval(szResult);
					cache_get_field_content(row,  "TeleJob", szResult, MainPipeline); PlayerInfo[extraid][pTeleJob] = strval(szResult);
					cache_get_field_content(row,  "GiayPhepVuKhi", szResult, MainPipeline); PlayerInfo[extraid][pGiayPhepVuKhi] = strval(szResult);
					cache_get_field_content(row,  "QuyenLuc", szResult, MainPipeline); PlayerInfo[extraid][pQuyenLuc] = strval(szResult);
					cache_get_field_content(row,  "CapGiayPhep", szResult, MainPipeline); PlayerInfo[extraid][pCapGiayPhep] = strval(szResult);
					cache_get_field_content(row,  "DuocCapGiay", szResult, MainPipeline); PlayerInfo[extraid][pDuocCapGiay] = strval(szResult);
					cache_get_field_content(row,  "RauBan", szResult, MainPipeline); PlayerInfo[extraid][pRauban] = strval(szResult);
					cache_get_field_content(row,  "RauSach", szResult, MainPipeline); PlayerInfo[extraid][pRausach] = strval(szResult);
					cache_get_field_content(row,  "OLD", szResult, MainPipeline); PlayerInfo[extraid][pOLD] = strval(szResult);
					cache_get_field_content(row,  "Da", szResult, MainPipeline); PlayerInfo[extraid][pDa] = strval(szResult);
					cache_get_field_content(row,  "BanhTrungThu", szResult, MainPipeline); PlayerInfo[extraid][pBanhTrungThu] = strval(szResult);
					cache_get_field_content(row,  "KGFish", szResult, MainPipeline); PlayerInfo[extraid][pKGFish] = strval(szResult);
		...
		case IPBAN_THREAD:
		{
		    if(rows > 0)
			{
				SendClientMessage(extraid, COLOR_RED, "IP cua ban bi cam truy cap, de mo khoa vui long truy cap gvrrp.com");
				SetTimerEx("KickEx", 1000, 0, "i", extraid);
			}
			else
			{
...
stock g_mysql_SaveAccount(playerid)
{
	...
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "TuiCanSa", PlayerInfo[playerid][pTuicansa]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "TienBan", PlayerInfo[playerid][pTienban]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "CanCuoc", PlayerInfo[playerid][pCancuoc]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Dau", PlayerInfo[playerid][pDau]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "GoiPot", PlayerInfo[playerid][pGoiPot]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "NhanQua", PlayerInfo[playerid][pNhanQua]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "PhieuThuong", PlayerInfo[playerid][pPhieuThuong]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "TeleJob", PlayerInfo[playerid][pTeleJob]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "GiayPhepVuKhi", PlayerInfo[playerid][pGiayPhepVuKhi]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "QuyenLuc", PlayerInfo[playerid][pQuyenLuc]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "CapGiayPhep", PlayerInfo[playerid][pCapGiayPhep]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "DuocCapGiay", PlayerInfo[playerid][pDuocCapGiay]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "RauBan", PlayerInfo[playerid][pRauban]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "RauSach", PlayerInfo[playerid][pRausach]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "OLD", PlayerInfo[playerid][pOLD]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Da", PlayerInfo[playerid][pDa]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "BanhTrungThu", PlayerInfo[playerid][pBanhTrungThu]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "KGFish", PlayerInfo[playerid][pKGFish]);
	...
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "XacNhanDangKy", PlayerInfo[playerid][pXacNhanDangKy]);
		...
		case 1:
		{
			if(rows > 0)
			{
				...
				for(new i; i < rows; i++)
				{
					...
					format(hhour, sizeof(hhour), "%s", str_replace_prefix(":00:00", "", hhour));
					chour = strval(hhour);
